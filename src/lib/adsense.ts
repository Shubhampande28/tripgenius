...
export const AD_SLOTS = {
  ...
  visitMidContent:  '3154352301', // Real unit: "Visit Page Mid-Content" (Display/Responsive) — /visit/[city]/[month] only, after the "vs best time" context section, before Things to do (2026-09 Zone 4 scoped rollout)
} as const;
