...
export interface BlogPost {
  ...
  coverPhoto: string;
  citySlug?: string;
  /** City slugs this post covers — powers the "Guides & Itineraries" module on
   *  city pages. Populated for existing posts by scripts/populate-post-cities.mjs
   *  (citySlug + tags + title match); maintain by hand on new posts. */
  cities?: string[];
  content: BlockType[];
  faqs?: FAQ[];
...
export const allPosts: BlogPost[] = [
...

  {
    ...
    content: [
      {
        type: 'p',
        text: 'Two of the most searched international destinations for Indian travellers. Bali and Thailand are often on the same shortlist — and for good reason. Both offer affordable prices, warm weather, easy entry for Indians, and a world-class travel experience. But they are fundamentally different places, and choosing the wrong one for your travel style can leave you disappointed. Here is the honest comparison.',
      },
      {
        type: 'h2',
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Indian ordinary passport holders are covered by Thailand visa-exemption rules for short tourist visits. No prior tourist visa is usually needed for standard holidays, but you should carry a return ticket, proof of accommodation and check the current permitted duration before travelling.",
      },
      {
  ...
  // ── POST 11 ───────────────────────────────────────────────────────
  {
    ...
    title: 'Dubai Travel Guide 2026: Is It Worth It? (Honest Review)',
    ...
    content: [
      ...
      { type: 'link-cta', text: 'Read the Dubai visa guide for Indian passport holders before booking flights.', href: '/blog/dubai-visa-guide-indians' },
      ...
      { type: 'link-cta', text: 'Planning your first trip? Use the Dubai 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'link-cta', text: 'Need exact costs and free ideas? Read the Dubai budget guide.', href: '/blog/dubai-budget-travel-guide' },
      { type: 'link-cta', text: 'Choosing hotels? Compare the best areas to stay in Dubai.', href: '/blog/where-to-stay-in-dubai' },
    ],
    faqs: [
      {
  ...
  {
    slug: 'dubai-5-day-itinerary',
    title: 'Dubai 5-Day Itinerary 2026: First-Time Route with Costs and Tips',
    excerpt: 'A realistic 5-day Dubai itinerary for first-time visitors — Burj Khalifa, old Dubai, desert safari, beaches, Abu Dhabi day trip, costs and transport.',
    date: '2025-10-04',
    readTime: 10,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'link-cta', text: 'Start with the complete Dubai travel guide before choosing your route.', href: '/blog/dubai-travel-guide-2025' },
      { type: 'h2', text: '5-Day Dubai Route' },
      { type: 'table', headers: ['Day', 'Focus', 'Plan'], rows: [
        ['Day 1', 'Downtown Dubai', 'Dubai Mall, Dubai Fountain, Burj Khalifa and a relaxed dinner.'],
        ['Day 2', 'Old Dubai', 'Al Fahidi, Dubai Creek abra, Gold Souk, Spice Souk and Deira food.'],
        ['Day 3', 'Desert Safari', 'Slow morning, beach or mall, then evening desert safari.'],
        ['Day 4', 'Abu Dhabi', 'Sheikh Zayed Grand Mosque, Louvre Abu Dhabi or Qasr Al Watan.'],
        ['Day 5', 'Beach and Marina', 'Jumeirah, Dubai Marina, Palm viewpoints or final shopping.'],
      ]},
      { type: 'link-cta', text: 'Use the Abu Dhabi day trip guide for Day 4.', href: '/blog/abu-dhabi-day-trip-from-dubai' },
      { type: 'h2', text: 'Budget for 5 Days' },
      { type: 'table', headers: ['Style', 'Daily Budget', '5-Day Land Cost'], rows: [
        ['Budget', '₹6,000–9,000', '₹30,000–45,000'],
        ['Comfortable', '₹12,000–20,000', '₹60,000–1,00,000'],
        ['Premium', '₹30,000+', '₹1,50,000+'],
      ]},
      { type: 'link-cta', text: 'For a deeper cost breakdown, read the Dubai budget guide.', href: '/blog/dubai-budget-travel-guide' },
      { type: 'h2', text: 'Planning Notes' },
      { type: 'ul', items: [
        'Book Burj Khalifa sunset slots early; they sell out and cost more.',
        'Do old Dubai in the morning or late afternoon, not peak heat.',
        'Keep the desert safari away from your arrival day.',
        'Use metro for Downtown/Marina and taxis for awkward beach routes.',
      ]},
    ],
    faqs: [
      { question: 'Is 5 days enough for Dubai?', answer: 'Yes. Five days is enough for Downtown Dubai, old Dubai, a desert safari, beach time and an Abu Dhabi day trip without rushing.' },
      { question: 'How much does a 5-day Dubai trip cost?', answer: 'A budget 5-day Dubai trip excluding flights can cost ₹30,000–45,000 per person. A comfortable trip usually costs ₹60,000–1,00,000 depending on hotels and paid attractions.' },
      { question: 'Should I include Abu Dhabi in a Dubai itinerary?', answer: 'Yes, if you have five days. Sheikh Zayed Grand Mosque and Louvre Abu Dhabi add cultural depth that Dubai alone often lacks.' },
      { question: 'What is the best first-time Dubai itinerary?', answer: 'The best first-time route is Downtown Dubai, old Dubai, desert safari, Abu Dhabi and one beach or Marina day.' },
    ],
  },

  {
    slug: 'dubai-budget-travel-guide',
    title: 'Dubai Budget Travel Guide 2026: Costs, Transport and Free Things To Do',
    excerpt: 'A practical Dubai cost guide — hotels, food, metro, taxis, attractions, free experiences and how to avoid overspending in the UAE.',
    date: '2025-10-06',
    readTime: 10,
    category: 'Budget',
    ...
    content: [
      ...
      { type: 'link-cta', text: 'Use this budget guide alongside the Dubai 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'Daily Dubai Budget' },
      { type: 'table', headers: ['Style', 'Daily Budget', 'Hotel Type'], rows: [
        ['Budget', '₹6,000–9,000', 'Deira/Bur Dubai budget hotel or hostel'],
        ['Comfortable', '₹12,000–20,000', 'Business hotel near metro'],
        ['Premium', '₹30,000+', 'Downtown, Marina or Palm resort'],
      ]},
      { type: 'h2', text: 'Where Money Goes' },
      { type: 'table', headers: ['Category', 'Budget Range', 'How To Save'], rows: [
        ['Hotels', '₹3,500–20,000+/night', 'Stay in Deira, Bur Dubai or near metro.'],
        ['Food', '₹800–4,000/day', 'Eat in Deira, Karama and mall food courts.'],
        ['Transport', '₹400–2,500/day', 'Use metro; limit taxis.'],
        ['Attractions', '₹0–10,000/day', 'Pick 2–3 paid highlights only.'],
      ]},
      { type: 'link-cta', text: 'For no-cost ideas, use the free things to do in Dubai guide.', href: '/blog/free-things-to-do-in-dubai' },
      { type: 'h2', text: 'Best Value Paid Experiences' },
      { type: 'ul', items: [
        'Burj Khalifa if booked in a non-prime slot.',
        'Desert safari from a reputable operator.',
        'Dubai Frame for a shorter, cheaper skyline experience.',
        'Abra creek crossing, which is almost free and more memorable than many paid attractions.',
      ]},
      { type: 'link-cta', text: 'Choosing hotels? Read where to stay in Dubai before booking.', href: '/blog/where-to-stay-in-dubai' },
    ],
    faqs: [
      { question: 'Can Dubai be done on a budget?', answer: 'Yes, if you stay in Deira or Bur Dubai, use metro, eat at local restaurants and limit paid attractions. It will still cost more than Southeast Asia.' },
      { question: 'How much money do I need per day in Dubai?', answer: 'Budget travellers need around ₹6,000–9,000 per day excluding flights. Comfortable travellers usually spend ₹12,000–20,000 per day.' },
      { question: 'What is free in Dubai?', answer: 'Dubai Fountain, Dubai Mall browsing, old souks, abra rides at very low cost, Jumeirah beach areas, Al Fahidi walks and many waterfront promenades are free or nearly free.' },
      { question: 'Is Dubai cheaper than Singapore?', answer: 'Dubai can be cheaper for flights from India and some hotels, but Singapore is often more predictable for public transport and food costs.' },
    ],
  },

  {
    slug: 'best-time-to-visit-dubai',
    title: 'Best Time to Visit Dubai 2026: Weather, Events and Cheapest Months',
    excerpt: 'The month-by-month Dubai weather guide — best season, cheapest months, summer heat, Ramadan, shopping festivals and when to avoid outdoor plans.',
    date: '2025-10-08',
    readTime: 8,
    category: 'Planning',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Overall Months' },
      { type: 'p', text: 'November to March is the best time to visit Dubai. Temperatures are pleasant, desert safaris are comfortable and beaches actually work. December and January are busiest; November and February are the strongest balance of weather and value.' },
      { type: 'h2', text: 'Dubai Month by Month' },
      { type: 'table', headers: ['Month', 'Weather', 'Travel Note'], rows: [
        ['January', 'Pleasant, busy', 'Great weather, higher prices.'],
        ['February', 'Pleasant', 'Excellent balance for most visitors.'],
        ['March', 'Warm but comfortable', 'Good for beaches and desert.'],
        ['April', 'Hotter', 'Shoulder season, manageable early/late.'],
        ['May', 'Very hot', 'Indoor-heavy trips only.'],
        ['June–September', 'Extreme heat', 'Cheapest hotels; avoid outdoor sightseeing.'],
        ['October', 'Improving', 'Good shoulder month if heat is tolerable.'],
        ['November', 'Excellent', 'Best value-weather combination.'],
        ['December', 'Excellent, crowded', 'Book early for holidays.'],
      ]},
      { type: 'link-cta', text: 'Build the right seasonal route with the Dubai 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'Ramadan Travel Notes' },
      { type: 'p', text: 'Dubai remains visitable during Ramadan, but public behaviour should be respectful. Iftar meals can be excellent, nightlife rhythms shift and some daytime dining may be more discreet depending on venue.' },
      { type: 'link-cta', text: 'For cost differences by season, see the Dubai budget guide.', href: '/blog/dubai-budget-travel-guide' },
    ],
    faqs: [
      { question: 'What is the best month to visit Dubai?', answer: 'November and February are the best overall months because the weather is excellent and prices are usually better than peak December-January.' },
      { question: 'When is Dubai cheapest?', answer: 'Dubai is usually cheapest from June to September because of extreme heat. Hotels discount heavily, but outdoor sightseeing is uncomfortable.' },
      { question: 'Is December good for Dubai?', answer: 'Yes, December has excellent weather, but it is crowded and expensive around Christmas and New Year.' },
      { question: 'When should I avoid Dubai?', answer: 'Avoid June to September if your trip depends on beaches, walking tours, desert activities or outdoor sightseeing.' },
    ],
  },

  {
    slug: 'dubai-family-trip-guide',
    title: 'Dubai Family Trip Guide 2026: Best Areas, Attractions, Hotels and Itinerary',
    excerpt: 'A family-focused Dubai guide covering where to stay, kid-friendly attractions, safe transport, beaches, desert safari choices and a simple itinerary.',
    date: '2025-10-10',
    readTime: 9,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Areas for Families' },
      { type: 'table', headers: ['Area', 'Best For', 'Why'], rows: [
        ['Downtown', 'First-timers', 'Burj Khalifa, Dubai Mall and fountains nearby.'],
        ['Jumeirah / Kite Beach', 'Beach families', 'More relaxed, good beach access.'],
        ['Dubai Marina / JBR', 'Older kids', 'Restaurants, beach, evening walks.'],
        ['Deira / Bur Dubai', 'Budget families', 'Cheaper hotels, old Dubai access.'],
      ]},
      { type: 'link-cta', text: 'Compare all hotel bases in where to stay in Dubai.', href: '/blog/where-to-stay-in-dubai' },
      { type: 'h2', text: 'Best Family Attractions' },
      { type: 'ul', items: [
        'Dubai Aquarium and Underwater Zoo if you are already at Dubai Mall.',
        'Dubai Fountain and Burj Khalifa for first-time wow factor.',
        'Kite Beach for an easy, low-pressure outdoor break.',
        'Dubai Frame for skyline views without a full Burj Khalifa budget.',
        'Desert safari only with a family-friendly operator and gentler dune bashing.',
      ]},
      { type: 'link-cta', text: 'Use the Dubai 5-day itinerary and slow it down for children.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'Family Travel Tips' },
      { type: 'ul', items: [
        'Avoid summer unless your trip is almost entirely indoor.',
        'Keep one major paid attraction per day.',
        'Use taxis when travelling with small children, but choose metro-friendly hotels for flexibility.',
        'Carry light layers for malls; air-conditioning can be aggressive.',
      ]},
    ],
    faqs: [
      { question: 'Is Dubai good for a family trip?', answer: 'Yes. Dubai is safe, clean, well-connected and full of family-friendly hotels, malls, beaches and attractions.' },
      { question: 'Where should families stay in Dubai?', answer: 'Downtown is easiest for first-timers, Jumeirah is best for beach access, Marina/JBR suits older kids and Deira/Bur Dubai works for budget families.' },
      { question: 'Is desert safari safe for kids?', answer: 'It can be safe with the right operator, but choose gentler dune bashing or private options for young children, pregnant travellers or anyone prone to motion sickness.' },
      { question: 'How many days are enough for Dubai with family?', answer: 'Four to five days is ideal for a first family trip.' },
    ],
  },

  {
    slug: 'abu-dhabi-day-trip-from-dubai',
    title: 'Abu Dhabi Day Trip from Dubai 2026: Mosque, Louvre, Qasr Al Watan and Costs',
    excerpt: 'Plan the best Abu Dhabi day trip from Dubai — Sheikh Zayed Grand Mosque, Louvre Abu Dhabi, Qasr Al Watan, transport, timing, dress code and costs.',
    date: '2025-10-12',
    readTime: 9,
    category: 'Asia',
    tags: ['Abu Dhabi', 'Dubai', 'UAE', 'Day Trip', 'Culture'],
    cities: ['dubai', 'abu-dhabi'],
    coverPhoto: 'photo-1512632578888-169bbbc64f33',
    content: [
      { type: 'p', text: 'Abu Dhabi gives a Dubai trip what Dubai sometimes lacks: stillness, scale and cultural weight. The Sheikh Zayed Grand Mosque alone is worth the day trip, and pairing it with Louvre Abu Dhabi or Qasr Al Watan makes the route feel complete.' },
      { type: 'link-cta', text: 'Add this as Day 4 of the Dubai 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'Best One-Day Route' },
      { type: 'table', headers: ['Time', 'Stop', 'Notes'], rows: [
        ['Morning', 'Sheikh Zayed Grand Mosque', 'Go early; follow dress code carefully.'],
        ['Lunch', 'Saadiyat / Corniche area', 'Keep it simple; avoid long detours.'],
        ['Afternoon', 'Louvre Abu Dhabi or Qasr Al Watan', 'Choose one, not both, if travelling with kids.'],
        ['Evening', 'Return to Dubai', 'Traffic can affect timings.'],
      ]},
      { type: 'h2', text: 'Transport Options' },
      { type: 'table', headers: ['Option', 'Best For', 'Trade-Off'], rows: [
        ['Private car/driver', 'Families and groups', 'Most comfortable, costlier.'],
        ['Guided tour', 'First-timers', 'Easy but less flexible.'],
        ['Bus', 'Budget travellers', 'Cheap but slower and less convenient.'],
      ]},
      { type: 'h2', text: 'Dress Code' },
      { type: 'p', text: 'For the Grand Mosque, shoulders, arms and legs should be covered. Women need head covering. Avoid transparent or tight clothing. Rules are enforced, so dress conservatively rather than negotiating at the entrance.' },
      { type: 'link-cta', text: 'Compare Dubai and Abu Dhabi if you are deciding where to spend more time.', href: '/blog/dubai-vs-abu-dhabi' },
    ],
    faqs: [
      { question: 'Is Abu Dhabi worth a day trip from Dubai?', answer: 'Yes. The Sheikh Zayed Grand Mosque, Louvre Abu Dhabi and Qasr Al Watan add cultural depth to a Dubai trip.' },
      { question: 'How far is Abu Dhabi from Dubai?', answer: 'Abu Dhabi is roughly 1.5 to 2 hours from Dubai by road depending on your starting point and traffic.' },
      { question: 'Can I visit Abu Dhabi without a tour?', answer: 'Yes, but a private driver or organised tour is easier for most travellers because attractions are spread out.' },
      { question: 'What should I wear to Sheikh Zayed Grand Mosque?', answer: 'Dress modestly with arms and legs covered. Women need a head covering. Avoid tight, transparent or sleeveless clothing.' },
    ],
  },

  {
    slug: 'dubai-visa-guide-indians',
    title: 'Dubai Visa Guide for Indians 2026: Eligibility, Documents, Fees and Application Routes',
    excerpt: 'Current Dubai/UAE visa guidance for Indian passport holders — visa-on-arrival eligibility, advance tourist visa options, documents, fees and airport checks.',
    date: '2025-10-14',
    readTime: 8,
    category: 'Planning',
    ...
    content: [
      ...
      { type: 'h2', text: 'Who May Get Visa on Arrival' },
      { type: 'p', text: 'Indian nationals with a normal passport valid for at least six months may be eligible for visa on arrival if they hold qualifying valid US, UK or EU documentation. Some UAE sources and airlines list additional qualifying residence permits; always check the exact current rule before relying on arrival processing.' },
      { type: 'h2', text: 'Who Should Apply in Advance' },
      { type: 'p', text: 'Indian travellers without qualifying documentation should arrange a UAE tourist visa before travel through a UAE airline, authorised travel agency, UAE-based sponsor, GDRFA or ICP channel. Do not rely on informal agents or social-media claims.' },
      { type: 'h2', text: 'Documents To Keep Ready' },
      { type: 'ul', items: [
        'Passport valid for at least six months.',
        'Return or onward ticket.',
        'Hotel booking or host details.',
        'Travel insurance and proof of funds if requested.',
        'Qualifying visa/residence document if using visa on arrival eligibility.',
      ]},
      { type: 'link-cta', text: 'Plan the trip route after confirming visa eligibility.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'link-cta', text: 'See the main Dubai travel guide for practical planning.', href: '/blog/dubai-travel-guide-2025' },
    ],
    faqs: [
      { question: 'Do Indians need a visa for Dubai?', answer: 'Most Indian passport holders need either advance UAE tourist visa approval or must qualify for UAE visa on arrival through specific valid US, UK, EU or other recognised documentation. Check official rules before travel.' },
      { question: 'Can Indians get visa on arrival in Dubai?', answer: 'Some Indian nationals can get visa on arrival if they meet UAE eligibility rules and hold qualifying valid documentation with sufficient passport validity.' },
      { question: 'Where can Indians apply for a Dubai visa?', answer: 'Indian travellers can apply through UAE airlines, authorised travel agencies, UAE resident sponsors, GDRFA or ICP channels depending on visa type and eligibility.' },
      { question: 'How long should my passport be valid for Dubai?', answer: 'Your passport should generally be valid for at least six months from entry into the UAE.' },
    ],
  },

  {
    slug: 'where-to-stay-in-dubai',
    title: 'Where To Stay in Dubai 2026: Best Areas for First-Timers, Families and Couples',
    excerpt: 'A practical Dubai neighbourhood guide — Downtown, Marina, JBR, Deira, Bur Dubai, Jumeirah and Palm Jumeirah compared by cost, transport and trip style.',
    date: '2025-10-16',
    readTime: 9,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Dubai Areas Compared' },
      { type: 'table', headers: ['Area', 'Best For', 'Trade-Off'], rows: [
        ['Downtown Dubai', 'First-timers, Burj Khalifa', 'Expensive, busy.'],
        ['Dubai Marina / JBR', 'Beach plus nightlife', 'Far from old Dubai.'],
        ['Deira', 'Budget, souks, food', 'Less glossy.'],
        ['Bur Dubai', 'Budget families, old Dubai', 'Older hotels.'],
        ['Jumeirah', 'Beach and families', 'Less metro access.'],
        ['Palm Jumeirah', 'Resort stays', 'Costly and less convenient.'],
      ]},
      { type: 'link-cta', text: 'Match your hotel area to the Dubai 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'Best Area by Traveller Type' },
      { type: 'ul', items: [
        'First-time visitor: Downtown if budget allows; Deira/Bur Dubai if budget matters.',
        'Family: Jumeirah, Downtown or a beach resort with easy taxis.',
        'Couple: Marina/JBR, Downtown or Palm for a splurge.',
        'Budget traveller: Deira or Bur Dubai near metro.',
      ]},
      { type: 'link-cta', text: 'For family-specific hotel planning, read the Dubai family trip guide.', href: '/blog/dubai-family-trip-guide' },
      { type: 'h2', text: 'Booking Tips' },
      { type: 'ul', items: [
        'Check metro distance, not just neighbourhood name.',
        'Summer prices can look tempting, but outdoor plans suffer.',
        'Avoid choosing Palm Jumeirah unless resort time is the point.',
        'For short layovers, stay near Downtown, Deira or the airport depending on timing.',
      ]},
    ],
    faqs: [
      { question: 'What is the best area to stay in Dubai for first-timers?', answer: 'Downtown Dubai is easiest if budget allows. Deira or Bur Dubai are better for budget first-timers who still want good access to old Dubai and metro.' },
      { question: 'Is Dubai Marina a good place to stay?', answer: 'Dubai Marina is good for beach access, restaurants and nightlife, but it is farther from old Dubai and some cultural sights.' },
      { question: 'Where should families stay in Dubai?', answer: 'Families should consider Downtown, Jumeirah, Marina/JBR or a resort depending on budget and whether beach time or attractions matter more.' },
      { question: 'Is Deira safe to stay in Dubai?', answer: 'Yes. Deira is safe and good value, with excellent food and souk access. It is less polished than Downtown or Marina.' },
    ],
  },

  {
    slug: 'dubai-3-day-itinerary',
    title: 'Dubai 3-Day Itinerary 2026: The Best Short Trip Plan',
    excerpt: 'A tight but realistic 3-day Dubai itinerary covering Burj Khalifa, old Dubai, desert safari, beaches, transport and what to skip.',
    date: '2025-10-18',
    readTime: 8,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: '3-Day Route' },
      { type: 'table', headers: ['Day', 'Plan'], rows: [
        ['Day 1', 'Dubai Mall, Burj Khalifa, Dubai Fountain and Downtown dinner.'],
        ['Day 2', 'Al Fahidi, Dubai Creek, Gold Souk, Spice Souk and evening desert safari.'],
        ['Day 3', 'Jumeirah beach, Dubai Marina/JBR, Dubai Frame or final shopping.'],
      ]},
      { type: 'link-cta', text: 'If you have more time, use the fuller Dubai 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'What To Skip on a 3-Day Trip' },
      { type: 'ul', items: [
        'Skip Abu Dhabi unless the Grand Mosque is your top priority.',
        'Skip multiple malls; one is enough.',
        'Skip Palm Jumeirah unless staying there or booking a specific experience.',
        'Skip expensive brunches if sightseeing time is limited.',
      ]},
      { type: 'link-cta', text: 'Keep costs under control with the Dubai budget guide.', href: '/blog/dubai-budget-travel-guide' },
    ],
    faqs: [
      { question: 'Is 3 days enough for Dubai?', answer: 'Three days is enough for a short Dubai introduction: Burj Khalifa, old Dubai, a desert safari and one beach or Marina stop.' },
      { question: 'Can I do Abu Dhabi in a 3-day Dubai trip?', answer: 'You can, but it will replace either your desert safari or beach/Marina day. Abu Dhabi fits better into a 5-day itinerary.' },
      { question: 'What should I skip in Dubai if short on time?', answer: 'Skip multiple malls, long brunches, Palm photo stops without a plan and overpacked paid attractions.' },
      { question: 'Where should I stay for 3 days in Dubai?', answer: 'Downtown, Deira/Bur Dubai or a metro-connected hotel works best for a short trip.' },
    ],
  },

  {
    slug: 'free-things-to-do-in-dubai',
    title: 'Free Things To Do in Dubai 2026: Beaches, Souks, Fountains and Viewpoints',
    excerpt: 'The best free and nearly free Dubai experiences — Dubai Fountain, old souks, beaches, creek abra, Al Fahidi, promenades and budget-friendly viewpoints.',
    date: '2025-10-20',
    readTime: 8,
    category: 'Budget',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Free or Nearly Free Experiences' },
      { type: 'ul', items: [
        'Dubai Fountain show outside Dubai Mall.',
        'Gold Souk and Spice Souk wandering in Deira.',
        'Abra ride across Dubai Creek for a tiny fare.',
        'Al Fahidi Historical Neighbourhood walks.',
        'Kite Beach and Jumeirah public beach areas.',
        'Dubai Marina and JBR promenade walks.',
        'Dubai Mall aquarium viewing panel from outside.',
      ]},
      { type: 'link-cta', text: 'Use these ideas to lower the cost of the Dubai 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'Best Low-Cost Paid Add-Ons' },
      { type: 'table', headers: ['Experience', 'Why It Works'], rows: [
        ['Dubai Frame', 'Cheaper skyline perspective than many premium viewpoints.'],
        ['Abra ride', 'Almost free and genuinely atmospheric.'],
        ['Old Dubai food crawl', 'Better value than many hotel restaurants.'],
        ['Non-prime Burj Khalifa slot', 'Still iconic if sunset is too expensive.'],
      ]},
      { type: 'link-cta', text: 'For the full money plan, read the Dubai budget guide.', href: '/blog/dubai-budget-travel-guide' },
    ],
    faqs: [
      { question: 'Are there free things to do in Dubai?', answer: 'Yes. Dubai Fountain, public beaches, Al Fahidi walks, souks, promenades and mall browsing are free or nearly free.' },
      { question: 'Is Dubai Fountain free?', answer: 'Yes. You can watch the Dubai Fountain show for free from public viewing areas near Dubai Mall.' },
      { question: 'Can budget travellers enjoy Dubai?', answer: 'Yes, if they use metro, stay in budget-friendly areas and mix free sights with a few paid highlights.' },
      { question: 'What is the best free experience in Dubai?', answer: 'The Dubai Fountain show and an old Dubai creek/souk walk are the best free or near-free experiences for first-timers.' },
    ],
  },

  {
    slug: 'dubai-desert-safari-guide',
    title: 'Dubai Desert Safari Guide 2026: Prices, Types, Best Time and What To Expect',
    excerpt: 'A practical Dubai desert safari guide — morning vs evening safaris, dune bashing, private tours, family safety, prices, inclusions and booking tips.',
    date: '2025-10-22',
    readTime: 8,
    category: 'Asia',
    tags: ['Dubai', 'Desert Safari', 'UAE', 'Adventure', 'Family Travel'],
    cities: ['dubai'],
    coverPhoto: 'photo-1500530855697-b586d89ba3ee',
    citySlug: 'dubai',
    content: [
      { type: 'p', text: 'A desert safari is touristy, yes. It is also one of the few Dubai experiences that gets you out of glass towers and into the landscape that existed before the skyline. Choose the right type and it can be genuinely memorable.' },
      { type: 'h2', text: 'Types of Desert Safari' },
      { type: 'table', headers: ['Type', 'Best For', 'Notes'], rows: [
        ['Evening group safari', 'Most first-timers', 'Dune bashing, sunset, dinner camp.'],
        ['Private safari', 'Families, couples', 'More control, higher cost.'],
        ['Morning safari', 'Short trips', 'Cooler, no camp dinner.'],
        ['Luxury conservation safari', 'Premium travellers', 'Less gimmicky, much pricier.'],
      ]},
      { type: 'link-cta', text: 'Fit the safari into Day 3 of the Dubai 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'Prices and Inclusions' },
      { type: 'p', text: 'Basic evening safaris can be cheap but inconsistent. Better operators cost more and usually include hotel pickup, dune bashing, sunset stop, dinner, basic entertainment and return transfer. Private or luxury options cost significantly more.' },
      { type: 'h2', text: 'Who Should Avoid Dune Bashing' },
      { type: 'ul', items: [
        'Pregnant travellers.',
      ...
      { type: 'link-cta', text: 'Travelling with children? Read the Dubai family trip guide.', href: '/blog/dubai-family-trip-guide' },
    ],
    faqs: [
      { question: 'Is Dubai desert safari worth it?', answer: 'Yes, for most first-time visitors. It is touristy but memorable, especially if you choose a reputable operator.' },
      { question: 'How much does a Dubai desert safari cost?', answer: 'Prices vary widely. Cheap group tours can be low-cost, while better group safaris, private tours and luxury conservation safaris cost much more.' },
      { question: 'Is dune bashing safe?', answer: 'It is generally safe with licensed operators, but it is not suitable for pregnant travellers, very young children, or people with back, neck or motion-sickness issues.' },
      { question: 'What is the best time for desert safari in Dubai?', answer: 'November to March is most comfortable. Evening safaris are the most popular because they include sunset and dinner.' },
    ],
  },

  {
    slug: 'dubai-shopping-guide',
    title: 'Dubai Shopping Guide 2026: Malls, Souks, Gold, Dates and What To Buy',
    excerpt: 'What to buy in Dubai and where — Dubai Mall, Mall of the Emirates, Gold Souk, perfumes, dates, electronics, spices and shopping festival tips.',
    date: '2025-10-24',
    readTime: 8,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Things To Buy' },
      { type: 'ul', items: [
        'Gold jewellery from Deira Gold Souk after checking current gold rates.',
        'Dates, especially premium varieties from reputable stores.',
        'Arabic perfumes, oud and bakhoor.',
        'Spices and saffron from the Spice Souk, with careful quality checks.',
        'Fashion and electronics only when sale pricing is genuinely better than India.',
      ]},
      { type: 'link-cta', text: 'Combine souks with old Dubai in the 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'Malls vs Souks' },
      { type: 'table', headers: ['Place', 'Best For', 'Tip'], rows: [
        ['Dubai Mall', 'Brands, aquarium, fountain', 'Go for the experience, not only shopping.'],
        ['Mall of the Emirates', 'Brands, Ski Dubai novelty', 'Useful but not essential.'],
        ['Gold Souk', 'Gold jewellery', 'Compare making charges.'],
        ['Spice Souk', 'Spices, saffron, souvenirs', 'Bargain politely.'],
      ]},
      { type: 'link-cta', text: 'Keep the shopping day affordable with the Dubai budget guide.', href: '/blog/dubai-budget-travel-guide' },
    ],
    faqs: [
      { question: 'What is worth buying in Dubai?', answer: 'Gold, dates, Arabic perfumes, oud, spices and some sale-priced branded items can be worth buying in Dubai.' },
      { question: 'Is gold cheaper in Dubai?', answer: 'Gold pricing can be competitive, but always compare live gold rates, making charges and customs rules before buying.' },
      { question: 'Which is better, Dubai Mall or Gold Souk?', answer: 'Dubai Mall is better for brands and spectacle. Gold Souk is better for traditional shopping and jewellery.' },
      { question: 'When is Dubai Shopping Festival?', answer: 'Dubai Shopping Festival usually runs in winter, but exact dates change each season. Check official event dates before planning around it.' },
    ],
  },

  {
    slug: 'dubai-honeymoon-guide',
    title: 'Dubai Honeymoon Guide 2026: Romantic Hotels, Experiences and Itinerary',
    excerpt: 'Plan a Dubai honeymoon with the best areas, romantic hotels, desert experiences, beach time, Abu Dhabi add-ons, costs and weather tips.',
    date: '2025-10-26',
    readTime: 9,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Honeymoon Areas' },
      { type: 'table', headers: ['Area', 'Best For', 'Trade-Off'], rows: [
        ['Downtown', 'First-time luxury and skyline', 'Busy and expensive.'],
        ['Palm Jumeirah', 'Resort honeymoon', 'Less convenient for sightseeing.'],
        ['Jumeirah', 'Beach plus city access', 'Fewer metro options.'],
        ['Marina/JBR', 'Restaurants and nightlife', 'Can feel crowded.'],
      ]},
      { type: 'link-cta', text: 'Compare hotel areas in where to stay in Dubai.', href: '/blog/where-to-stay-in-dubai' },
      { type: 'h2', text: 'Romantic 5-Day Plan' },
      { type: 'table', headers: ['Day', 'Plan'], rows: [
        ['Day 1', 'Arrive, Downtown dinner, fountain show.'],
        ['Day 2', 'Burj Khalifa, spa or beach, rooftop drinks.'],
        ['Day 3', 'Private or premium desert safari.'],
        ['Day 4', 'Abu Dhabi mosque and Louvre/Qasr Al Watan.'],
        ['Day 5', 'Palm, beach club or relaxed shopping.'],
      ]},
      { type: 'link-cta', text: 'Use the main Dubai itinerary as the base plan.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'Honeymoon Tips' },
      { type: 'ul', items: [
        'Avoid summer if outdoor photos, beaches and desert sunsets matter.',
        'Choose one splurge: hotel, dinner, private safari or spa.',
        'Do not overpack every day; Dubai honeymoons work best with downtime.',
        'Consider Abu Dhabi for cultural contrast.',
      ]},
    ],
    faqs: [
      { question: 'Is Dubai good for honeymoon?', answer: 'Yes. Dubai is good for couples who want luxury hotels, easy logistics, rooftop dining, beaches, desert sunsets and polished service.' },
      { question: 'Which area is best for honeymoon in Dubai?', answer: 'Palm Jumeirah is best for resort honeymoons, Downtown for skyline luxury, and Jumeirah for beach plus city access.' },
      { question: 'How many days are enough for a Dubai honeymoon?', answer: 'Four to six days is ideal for a Dubai honeymoon.' },
      { question: 'What is the best time for a Dubai honeymoon?', answer: 'November to March is best because outdoor dining, beaches and desert experiences are comfortable.' },
    ],
  },

  {
    slug: 'dubai-food-guide',
    title: 'Dubai Food Guide 2026: Emirati Food, Indian Restaurants and Street Eats',
    excerpt: 'What to eat in Dubai — Emirati dishes, old Dubai restaurants, Indian food, shawarma, dates, fine dining, food courts and budget-friendly areas.',
    date: '2025-10-28',
    readTime: 9,
    category: 'Asia',
    tags: ['Dubai', 'Food', 'UAE', 'Indian Food', 'Culture'],
    cities: ['dubai'],
    coverPhoto: 'photo-1555396273-367ea4eb4db5',
    citySlug: 'dubai',
    content: [
      { type: 'p', text: 'Dubai\'s food scene is not one cuisine. It is Emirati, Indian, Lebanese, Iranian, Filipino, Pakistani, fine dining and mall food all layered together by migration. The best meals are often not the most expensive ones.' },
      ...
      { type: 'link-cta', text: 'Use old Dubai food stops inside the Dubai 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'h2', text: 'Best Food Areas' },
      { type: 'table', headers: ['Area', 'Best For', 'Budget'], rows: [
        ['Deira', 'Old Dubai, grills, budget meals', 'Low to mid'],
        ['Karama', 'Indian and Pakistani food', 'Low to mid'],
        ['Downtown', 'Restaurants with views', 'Mid to high'],
        ['Jumeirah', 'Cafes and beach dining', 'Mid to high'],
      ]},
      { type: 'link-cta', text: 'For budget planning, read the Dubai budget guide.', href: '/blog/dubai-budget-travel-guide' },
    ],
    faqs: [
      { question: 'What food is Dubai famous for?', answer: 'Dubai is known for Emirati dishes such as machboos, Arabic coffee and dates, plus shawarma, grills and a huge Indian/Pakistani restaurant scene.' },
      { question: 'Is Indian food easy to find in Dubai?', answer: 'Yes. Indian food is extremely easy to find, especially in Karama, Deira, Bur Dubai and mall food courts.' },
      { question: 'Where should budget travellers eat in Dubai?', answer: 'Deira, Karama and Bur Dubai are best for budget meals and excellent South Asian food.' },
      { question: 'Is Dubai good for vegetarians?', answer: 'Yes. Vegetarian Indian food is widely available, and many Lebanese, cafe and hotel restaurants also have vegetarian options.' },
    ],
  },

  {
    slug: 'dubai-layover-guide',
    title: 'Dubai Layover Guide 2026: 6, 12 and 24 Hour Itineraries',
    excerpt: 'How to use a Dubai layover — airport exits, 6-hour, 12-hour and 24-hour plans, transport, visas, luggage, Burj Khalifa and old Dubai options.',
    date: '2025-10-30',
    readTime: 8,
    category: 'Planning',
    ...
    content: [
      ...
      { type: 'link-cta', text: 'Check visa eligibility first in the Dubai visa guide for Indians.', href: '/blog/dubai-visa-guide-indians' },
      { type: 'h2', text: 'Layover Plans' },
      { type: 'table', headers: ['Layover', 'Best Plan', 'Notes'], rows: [
        ['6 hours', 'Stay near airport or quick old Dubai meal', 'Only exit if immigration and luggage timing are safe.'],
        ['12 hours', 'Burj Khalifa/Dubai Mall or old Dubai creek route', 'Choose one zone.'],
        ['24 hours', 'Downtown, old Dubai and one beach/Marina stop', 'Book a hotel if overnight.'],
      ]},
      { type: 'h2', text: 'Best Short Routes' },
      { type: 'ul', items: [
      ...
      { type: 'link-cta', text: 'If your layover becomes a short trip, use the Dubai 3-day itinerary.', href: '/blog/dubai-3-day-itinerary' },
    ],
    faqs: [
      { question: 'Can I leave Dubai airport during a layover?', answer: 'You can leave if you meet UAE entry requirements, have enough time and your airline/luggage situation allows it.' },
      { question: 'Is 6 hours enough for a Dubai layover tour?', answer: 'Six hours is tight. It may work for a very quick airport-area or old Dubai stop, but immigration, security and transport can eat most of the time.' },
      { question: 'What can I do with 12 hours in Dubai?', answer: 'With 12 hours, choose either Downtown Dubai for Burj Khalifa/Dubai Mall or old Dubai for Al Fahidi, creek and souks.' },
      { question: 'Do Indians need a visa for a Dubai layover?', answer: 'Indian travellers need to meet UAE entry or transit visa rules before leaving the airport. Check current eligibility before relying on a layover exit.' },
    ],
  },

  {
    slug: 'dubai-vs-abu-dhabi',
    title: 'Dubai vs Abu Dhabi 2026: Which UAE City Should You Visit?',
    excerpt: 'Dubai vs Abu Dhabi compared — skyline, culture, beaches, costs, family travel, mosques, museums, nightlife and the best way to combine both.',
    date: '2025-11-01',
    readTime: 8,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'table', headers: ['Factor', 'Dubai', 'Abu Dhabi'], rows: [
        ['Best for', 'First-timers, shopping, nightlife', 'Culture, mosque, museums, calmer pace'],
        ['Top sight', 'Burj Khalifa / Downtown', 'Sheikh Zayed Grand Mosque'],
        ['Trip length', '3–5 days', '1–2 days'],
        ['Vibe', 'Fast, commercial, showy', 'Calmer, grand, formal'],
      ]},
      { type: 'link-cta', text: 'Plan Dubai with the 5-day itinerary.', href: '/blog/dubai-5-day-itinerary' },
      { type: 'link-cta', text: 'Plan Abu Dhabi as a day trip from Dubai.', href: '/blog/abu-dhabi-day-trip-from-dubai' },
      { type: 'h2', text: 'Which Should You Choose?' },
      { type: 'p', text: 'Choose Dubai for a first UAE trip, especially if you want Burj Khalifa, shopping, beach clubs, desert safari and easy hotel choice. Choose Abu Dhabi if architecture, museums and a calmer city matter more. Most travellers should use Dubai as the base and add Abu Dhabi for one day.' },
    ],
    faqs: [
      { question: 'Is Dubai or Abu Dhabi better for tourists?', answer: 'Dubai is better for first-time tourists because it has more attractions, hotels, nightlife and transport options. Abu Dhabi is better for culture, the Grand Mosque and a calmer pace.' },
      { question: 'Can I visit Abu Dhabi from Dubai in one day?', answer: 'Yes. Abu Dhabi works well as a day trip from Dubai if you focus on the Grand Mosque and one major cultural attraction.' },
      { question: 'Is Abu Dhabi cheaper than Dubai?', answer: 'Costs vary, but Dubai generally has more hotel range and more tourist spending traps. Abu Dhabi can feel calmer and less aggressively commercial.' },
      { question: 'Should I stay in Dubai or Abu Dhabi?', answer: 'For a first UAE trip, stay in Dubai and day-trip to Abu Dhabi unless your main interest is the Grand Mosque, museums or a specific Abu Dhabi event.' },
    ],
  },

  {
    slug: 'hidden-gems-in-dubai',
    title: 'Hidden Gems in Dubai 2026: Quiet Places Beyond Burj Khalifa and Dubai Mall',
    excerpt: 'Dubai hidden gems beyond the obvious sights — Al Fahidi, creek routes, local food areas, quiet beaches, galleries, lesser-known viewpoints and old trading streets.',
    date: '2025-11-03',
    readTime: 8,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Hidden Gems' },
      { type: 'ul', items: [
        'Al Fahidi Historical Neighbourhood early in the morning.',
        'Textile Souk and creek abra crossings.',
        'Karama for Indian and Pakistani food.',
        'Alserkal Avenue for galleries and design spaces.',
        'Jumeirah Mosque area and quieter public beach walks.',
        'Ras Al Khor Wildlife Sanctuary during flamingo season.',
      ]},
      { type: 'link-cta', text: 'Pair hidden gems with the main Dubai travel guide.', href: '/blog/dubai-travel-guide-2025' },
      { type: 'h2', text: 'How To Add Them to a Trip' },
      { type: 'p', text: 'Use hidden gems as replacements, not additions. Swap a second mall visit for Alserkal Avenue, a hotel dinner for Karama, or another skyline viewpoint for an old creek evening.' },
      { type: 'link-cta', text: 'For free and low-cost ideas, read free things to do in Dubai.', href: '/blog/free-things-to-do-in-dubai' },
    ],
    faqs: [
      { question: 'Does Dubai have hidden gems?', answer: 'Yes. Dubai\'s hidden gems are mostly older neighbourhoods, creek routes, food areas, galleries and quiet public spaces rather than secret natural sites.' },
      { question: 'What is the most underrated place in Dubai?', answer: 'Al Fahidi and the creek area are among Dubai\'s most underrated places because they show the city before the skyline era.' },
      { question: 'Where can I experience local Dubai?', answer: 'Try Al Fahidi, Deira, Bur Dubai, Karama and creek-side areas for a more local experience than Downtown or Marina.' },
      { question: 'Are hidden gems in Dubai free?', answer: 'Many are free or low-cost, including Al Fahidi walks, creek areas, souks, public beaches and some gallery areas.' },
    ],
  },
...

  {
    ...
    content: [
      ...
      { type: 'ul', items: [
        'Indian ordinary passport holders are covered by Thailand visa-exemption rules for short tourist stays, but the permitted duration can change with official updates.',
        'Required: passport with at least 6 months validity, return or onward ticket, proof of accommodation and proof of funds if requested.',
        'Thailand has tightened scrutiny around fake return tickets and repeated border runs. Have a real itinerary and verifiable bookings.',
        'Before booking non-refundable travel, verify the current duration on official Thai embassy, consular or immigration channels.',
      ]},
      ...
      { type: 'link-cta', text: 'Planning one week in Thailand? Use our day-by-day Thailand itinerary for Bangkok, beaches, food and transfers.', href: '/blog/thailand-7-day-itinerary' },
      { type: 'link-cta', text: 'Need exact costs? Read the Thailand budget guide with daily budgets in INR and USD.', href: '/blog/thailand-budget-travel-guide' },
      { type: 'link-cta', text: 'Timing your trip around weather and island seasons? See the best time to visit Thailand.', href: '/blog/best-time-to-visit-thailand' },
    ],
    faqs: [
      {
        question: "Do Indians need a visa for Thailand in 2025?",
        answer: "Indian ordinary passport holders are covered by Thailand visa-exemption rules for short tourist visits, so a prior tourist visa is usually not required for standard holidays. The exact permitted duration can change, so verify current official rules before booking.",
      },
      {
...

  {
    ...
    title: 'Thailand 7-Day Itinerary 2025: Bangkok, Phuket, Krabi or Chiang Mai',
    excerpt: 'A practical one-week Thailand itinerary for first-time visitors — Bangkok temples and food, island choices, realistic transfer times, daily costs and smart route options.',
    date: '2025-09-02',
    readTime: 10,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'link-cta', text: 'Start with the complete Thailand planning guide before choosing your exact route.', href: '/blog/thailand-travel-guide-2025' },
      { type: 'h2', text: 'Best 7-Day Thailand Route for First-Timers' },
      { type: 'table', headers: ['Day', 'Base', 'Plan'], rows: [
        ['Day 1', 'Bangkok', 'Arrive, check in near Sukhumvit or the riverside, eat at a night market, early sleep.'],
        ['Day 2', 'Bangkok', 'Grand Palace, Wat Pho, Wat Arun, Chao Phraya boat and Chinatown street food.'],
        ['Day 3', 'Bangkok', 'Chatuchak or floating market, Jim Thompson House, massage, rooftop bar.'],
        ['Day 4', 'Phuket or Krabi', 'Morning flight south. Beach afternoon and local dinner.'],
        ['Day 5', 'Phuket or Krabi', 'Island tour: Phi Phi from Phuket/Krabi or Hong Islands from Krabi.'],
        ['Day 6', 'Phuket or Krabi', 'Slow beach day, old town or viewpoints, sunset dinner.'],
        ['Day 7', 'Bangkok / Depart', 'Fly back to Bangkok if required, last shopping and departure.'],
      ]},
      { type: 'h2', text: 'Phuket or Krabi for This Itinerary?' },
      { type: 'p', text: 'Choose Phuket if you want easier flights, more hotels, nightlife, family infrastructure and a smoother first trip. Choose Krabi if you want limestone cliffs, quieter beaches, cheaper guesthouses and easier access to Railay, Hong Islands and Phi Phi without Phuket traffic.' },
      { type: 'link-cta', text: 'Choosing between the two beach bases? Read the Phuket vs Krabi comparison.', href: '/blog/phuket-vs-krabi' },
      { type: 'h2', text: 'Chiang Mai Swap Route' },
      { type: 'p', text: 'If beaches are not the priority, spend Days 4–6 in Chiang Mai instead of Phuket or Krabi. Visit Doi Suthep, take a cooking class, explore the Old City temples and spend one day at an ethical elephant sanctuary. Fly back to Bangkok on Day 7.' },
      { type: 'link-cta', text: 'See the Chiang Mai guide for temples, cafes, markets and day trips.', href: '/blog/chiang-mai-travel-guide' },
      { type: 'h2', text: 'Expected Budget' },
      { type: 'table', headers: ['Style', 'Daily Budget', '7-Day Land Cost', 'Who It Fits'], rows: [
        ['Budget', '₹3,000–5,000', '₹21,000–35,000', 'Hostels, street food, trains, shared tours'],
        ['Comfortable', '₹6,000–10,000', '₹42,000–70,000', 'Private rooms, Grab rides, good tours'],
        ['Premium', '₹15,000+', '₹1,05,000+', 'Resorts, private transfers, curated experiences'],
      ]},
      { type: 'link-cta', text: 'For a full cost breakdown, use the Thailand budget travel guide.', href: '/blog/thailand-budget-travel-guide' },
      { type: 'h2', text: 'Booking Tips' },
      { type: 'ul', items: [
        'Book domestic flights early if travelling December to February.',
        'Avoid changing hotels every night. Thailand rewards slower bases.',
        'Use Grab in Bangkok and Phuket when prices are clear; use boats for riverside Bangkok.',
        'Do island tours on your second beach day, not the last day, so weather delays do not break the plan.',
        'Keep temple clothing ready in Bangkok: shoulders and knees covered.',
      ]},
    ],
    faqs: [
      { question: 'Is 7 days enough for Thailand?', answer: 'Yes, 7 days is enough for Bangkok plus one beach destination such as Phuket or Krabi. It is not enough for Bangkok, Chiang Mai and multiple islands unless you are comfortable with a rushed trip and several flights.' },
      { question: 'What is the best Thailand itinerary for first-timers?', answer: 'The best first-time itinerary is 3 nights in Bangkok and 4 nights in Phuket or Krabi. It balances culture, street food, beaches and island tours without spending the entire week in transit.' },
      { question: 'How much does a 7-day Thailand trip cost from India?', answer: 'A budget 7-day trip usually costs ₹45,000–70,000 per person including flights if booked early. A comfortable mid-range trip costs ₹80,000–1,20,000 depending on hotels, domestic flights and island tours.' },
      { question: 'Should I choose Phuket or Krabi for a one-week Thailand trip?', answer: 'Choose Phuket for convenience, nightlife, family hotels and frequent flights. Choose Krabi for scenery, quieter beaches, lower costs and easier access to Railay and Hong Islands.' },
    ],
  },

  {
    slug: 'best-time-to-visit-thailand',
    title: 'Best Time to Visit Thailand 2025: Weather, Islands and Month-by-Month Guide',
    excerpt: 'The practical month-by-month guide to Thailand weather — when to visit Bangkok, Phuket, Krabi, Chiang Mai and Koh Samui, plus monsoon mistakes to avoid.',
    date: '2025-09-04',
    readTime: 9,
    category: 'Planning',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Overall Months' },
      { type: 'p', text: 'November to February is the safest window for most travellers: lower humidity, clearer skies and calm seas on the Andaman coast. December and January are the most expensive. November and February are the sweet spots for weather plus value.' },
      { type: 'h2', text: 'Thailand Month by Month' },
      { type: 'table', headers: ['Month', 'Weather', 'Best For', 'Watch Out For'], rows: [
        ['January', 'Dry, pleasant, busy', 'Bangkok, Phuket, Krabi, Chiang Mai', 'Peak hotel prices'],
        ['February', 'Dry and slightly warmer', 'Island trips, first-timers', 'Popular beaches still busy'],
        ['March', 'Hot, mostly dry', 'Bangkok, islands, diving', 'Northern smoke season'],
        ['April', 'Very hot, Songkran', 'Festivals, nightlife', 'Heat and holiday crowds'],
        ['May', 'Start of monsoon', 'Deals, flexible travellers', 'Rough seas on Andaman coast'],
        ['June', 'Mixed rain and sun', 'Budget trips', 'Unpredictable island tours'],
        ['July', 'Wet on Andaman, better Gulf odds', 'Koh Samui side', 'School-holiday prices in some areas'],
        ['August', 'Wet but not constant', 'Koh Samui, slow travel', 'Phuket/Krabi sea conditions'],
        ['September', 'Wettest month in many areas', 'Low prices', 'Tour cancellations'],
        ['October', 'Transition month', 'Flexible travellers', 'Weather varies by coast'],
        ['November', 'Dry season starts', 'Best value month', 'Some late storms possible'],
        ['December', 'Excellent weather', 'Families, honeymoons, beaches', 'Highest prices near Christmas'],
      ]},
      { type: 'h2', text: 'Best Time for Phuket and Krabi' },
      { type: 'p', text: 'For Phuket, Krabi, Phi Phi and the Andaman coast, November to April is best. May to October brings stronger currents, red flags and more cancelled speedboat trips. If the beach is the point of the holiday, do not gamble on September.' },
      { type: 'link-cta', text: 'Planning the Andaman coast? Compare Phuket and Krabi before choosing dates.', href: '/blog/phuket-vs-krabi' },
      { type: 'h2', text: 'Best Time for Koh Samui' },
      { type: 'p', text: 'Koh Samui, Koh Phangan and Koh Tao sit in the Gulf of Thailand and follow a different rhythm. February to September is generally workable, with July and August often better here than on the Phuket side. October and November are usually the wettest months.' },
      { type: 'h2', text: 'Best Time for Chiang Mai' },
      { type: 'p', text: 'November to February is beautiful in Chiang Mai: cooler mornings, clear mountain light and excellent walking weather. Avoid the worst of burning season, usually late February to April, if air quality is a concern.' },
      { type: 'link-cta', text: 'See temples, cafes and day trips in the Chiang Mai travel guide.', href: '/blog/chiang-mai-travel-guide' },
    ],
    faqs: [
      { question: 'What is the best month to visit Thailand?', answer: 'November and February are the best overall months because the weather is usually dry, seas are calmer and prices are lower than the Christmas-New Year peak.' },
      { question: 'When is monsoon season in Thailand?', answer: 'Most of Thailand sees monsoon conditions from May to October, but the Gulf islands such as Koh Samui often have better weather during parts of this period. September is usually one of the wettest months.' },
      { question: 'Is December a good time to visit Thailand?', answer: 'December is one of the best weather months for Thailand, especially Bangkok, Phuket and Krabi. It is also one of the most expensive months, so book hotels and domestic flights early.' },
      { question: 'When should I avoid Phuket?', answer: 'Avoid Phuket from September to early October if your trip depends on beaches, snorkelling and island tours. Seas can be rough, speedboats may cancel and red-flag beach days are common.' },
    ],
  },

  {
    slug: 'thailand-budget-travel-guide',
    title: 'Thailand Budget Travel Guide 2025: Daily Costs, Flights, Hotels and Food',
    excerpt: 'A realistic Thailand cost guide for Indian travellers — daily budgets, flight prices, hotels, street food, transport, island tours and where not to overspend.',
    date: '2025-09-06',
    readTime: 10,
    category: 'Budget',
    ...
    content: [
      ...
      { type: 'h2', text: 'Thailand Trip Cost at a Glance' },
      { type: 'table', headers: ['Trip Style', 'Daily Budget', '7 Days Excluding Flights', 'Best For'], rows: [
        ['Backpacker', '₹2,500–4,000', '₹17,500–28,000', 'Hostels, street food, buses, shared tours'],
        ['Budget comfort', '₹5,000–7,500', '₹35,000–52,500', 'Private rooms, Grab, selected tours'],
        ['Mid-range', '₹8,000–13,000', '₹56,000–91,000', 'Good hotels, flights, comfortable transfers'],
        ['Premium', '₹18,000+', '₹1,26,000+', 'Resorts, private tours, beach clubs'],
      ]},
      { type: 'h2', text: 'Flights from India' },
      { type: 'p', text: 'Return flights to Bangkok from Delhi, Mumbai, Kolkata, Chennai and Bengaluru often sit between ₹15,000 and ₹30,000 when booked 4–8 weeks ahead. Phuket can be costlier or require a connection. Bangkok is usually the cheapest entry point.' },
      { type: 'h2', text: 'Accommodation Costs' },
      { type: 'table', headers: ['Place', 'Budget Room', 'Good Mid-Range', 'Notes'], rows: [
        ['Bangkok', '₹1,500–3,000', '₹4,000–8,000', 'Stay near BTS/MRT to save transport time.'],
        ['Phuket', '₹2,000–4,500', '₹6,000–12,000', 'Patong is convenient; Kata/Karon are calmer.'],
        ['Krabi', '₹1,800–3,500', '₹4,500–9,000', 'Ao Nang has the best tour access.'],
        ['Chiang Mai', '₹1,200–2,800', '₹3,500–7,000', 'Best value among major tourist bases.'],
      ]},
      { type: 'h2', text: 'Food and Transport' },
      { type: 'p', text: 'Street food meals cost ₹100–300. Simple restaurants cost ₹350–700. Indian restaurants and beach-club meals can push the budget up quickly. In Bangkok, BTS/MRT and river boats are cheap and reliable. In Phuket, taxis are expensive, so choose your base carefully.' },
      { type: 'link-cta', text: 'For Bangkok-specific costs, read the Bangkok budget guide.', href: '/blog/bangkok-budget-travel-guide' },
      { type: 'h2', text: 'Activities and Tours' },
      { type: 'ul', items: [
      ...
      { type: 'link-cta', text: 'Compare Thailand with Bali for costs, visa and food before deciding.', href: '/blog/bali-vs-thailand-indian-travellers' },
    ],
    faqs: [
      { question: 'Is Thailand cheap for Indian tourists?', answer: 'Thailand is affordable compared with many international destinations, especially for food, local transport and hostels. The biggest costs are flights, beach hotels in peak season and island tours.' },
      { question: 'How much money do I need for 7 days in Thailand?', answer: 'Excluding international flights, budget travellers can manage 7 days in ₹25,000–40,000. A comfortable trip usually costs ₹50,000–90,000 depending on hotels and tours.' },
      { question: 'Is Bangkok cheaper than Phuket?', answer: 'Bangkok is usually cheaper for transport and food because public transport is excellent. Phuket can become expensive because taxis, beachfront hotels and island tours cost more.' },
      { question: 'What is the cheapest month to visit Thailand?', answer: 'May, June, September and October usually have lower hotel prices, but weather risk is higher. November often gives a better balance of improving weather and fair prices.' },
    ],
  },

  {
    slug: 'thailand-visa-guide-indians',
    title: 'Thailand Visa Guide for Indians 2025: Entry Rules, Documents and Costs',
    excerpt: 'Current Thailand entry guidance for Indian passport holders — visa-free stay, required documents, arrival checks, extensions and practical airport tips.',
    date: '2025-09-08',
    readTime: 7,
    category: 'Planning',
    ...
    content: [
      ...
      { type: 'h2', text: 'Documents To Carry' },
      { type: 'ul', items: [
      ...
      { type: 'h2', text: 'Arrival Process' },
      { type: 'p', text: 'At Bangkok, Phuket and other major airports, proceed to immigration with your passport and arrival details. Officers may ask where you are staying, how long you will stay and when you leave. Keep answers simple and consistent with your bookings.' },
      { type: 'link-cta', text: 'Build a clean route with the Thailand 7-day itinerary.', href: '/blog/thailand-7-day-itinerary' },
      ...
      { type: 'h2', text: 'Thailand vs Bali for Indian Entry' },
      { type: 'p', text: 'Thailand is currently easier than Bali for Indians because there is no airport visa fee for ordinary short tourist visits. Bali remains simple but requires a paid Visa on Arrival. If convenience and cost are deciding factors, Thailand has the edge.' },
      { type: 'link-cta', text: 'Read the full Bali vs Thailand comparison for Indian travellers.', href: '/blog/bali-vs-thailand-indian-travellers' },
    ],
    faqs: [
      { question: 'Do Indians need a visa for Thailand in 2025?', answer: 'Indian ordinary passport holders are covered by Thailand visa-exemption rules for short tourist visits. A prior tourist visa is usually not required for standard holidays, but the permitted duration and conditions should be checked with official Thai sources before travel.' },
      { question: 'What documents do Indians need for Thailand?', answer: 'Carry a valid passport, return or onward ticket, hotel booking, proof of funds and travel insurance. Immigration may not ask for every document, but you should have them ready.' },
      { question: 'Can Indians extend their stay in Thailand?', answer: 'Extensions depend on the entry category and current immigration rules. Visit a Thai immigration office before your permitted stay expires if you need more time.' },
      { question: 'Is Thailand easier than Bali for Indians?', answer: 'For short tourist trips, Thailand is usually easier because Indian travellers can enter without paying a visa-on-arrival fee, while Bali requires a paid VOA for Indonesia.' },
    ],
  },
...

  {
    ...
    cities: ['venice', 'florence', 'amalfi', 'rome'],
...

  {
    ...
    content: [
      ...
      { type: 'link-cta', text: 'Planning Phuket as part of a one-week route? Use the Thailand 7-day itinerary.', href: '/blog/thailand-7-day-itinerary' },
      { type: 'link-cta', text: 'Not sure if Krabi is a better fit? Read the Phuket vs Krabi comparison.', href: '/blog/phuket-vs-krabi' },
      { type: 'link-cta', text: 'For Maya Bay, snorkelling and boat routes, read the Phi Phi Islands guide.', href: '/blog/phi-phi-islands-guide' },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer: "Indian ordinary passport holders are covered by Thailand visa-exemption rules for short tourist visits, including Phuket. Bring a return ticket, proof of accommodation and enough funds, and verify the current permitted duration before travel.",
      },
    ],
  },

  {
    ...
    title: 'Bangkok 3-Day Itinerary 2025: Temples, Street Food, Markets and Rooftops',
    excerpt: 'A realistic three-day Bangkok itinerary covering temples, river boats, Chinatown street food, markets, malls, massages and rooftop views without rushing the city.',
    date: '2025-09-10',
    readTime: 9,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'link-cta', text: 'Use this Bangkok plan inside the full Thailand 7-day itinerary.', href: '/blog/thailand-7-day-itinerary' },
      { type: 'h2', text: 'Day 1: Riverside Temples and Chinatown' },
      { type: 'ol', items: [
        'Start early at the Grand Palace before the heat and tour groups peak.',
        'Walk to Wat Pho for the Reclining Buddha and a traditional massage if you have time.',
        'Cross the river to Wat Arun and climb the central prang before sunset.',
        'Take a Chao Phraya boat north or south instead of sitting in road traffic.',
        'End in Yaowarat, Bangkok\'s Chinatown, for seafood, noodles, mango sticky rice and neon-lit street food.',
      ]},
      { type: 'h2', text: 'Day 2: Markets, Jim Thompson House and Rooftop Views' },
      { type: 'p', text: 'If it is a weekend, start at Chatuchak Market. On weekdays, choose Or Tor Kor Market for food or Talat Noi for old shophouses and street art. Spend the afternoon at Jim Thompson House, then move to a rooftop bar or riverside restaurant for the evening.' },
      { type: 'link-cta', text: 'For costs, transport and cheap food, read the Bangkok budget guide.', href: '/blog/bangkok-budget-travel-guide' },
      { type: 'h2', text: 'Day 3: Modern Bangkok and Local Food' },
      { type: 'p', text: 'Use the final day for Sukhumvit, Siam or Ari depending on your style. Siam is best for malls and air-conditioning; Ari is better for cafes and a local neighbourhood feel. Book a cooking class or food walk if Thai food is a major reason for the trip.' },
      { type: 'h2', text: 'Where To Stay for This Itinerary' },
      { type: 'table', headers: ['Area', 'Best For', 'Why'], rows: [
      ...
      { type: 'link-cta', text: 'Read the complete Bangkok guide for broader planning tips.', href: '/blog/bangkok-travel-guide-tips' },
      { type: 'h2', text: 'Bangkok Transport Tips' },
      { type: 'ul', items: [
    ...
    faqs: [
      { question: 'Is 3 days enough in Bangkok?', answer: 'Three days is enough for Bangkok\'s major temples, Chinatown, markets, shopping and a few food experiences. It is not enough to see every neighbourhood, but it is ideal for a first Thailand trip.' },
      { question: 'Where should I stay in Bangkok for 3 days?', answer: 'Sukhumvit is the most practical first-time base because BTS access is excellent. Riverside is better for couples and families who want a calmer stay near the temples.' },
      { question: 'What should I not miss in Bangkok?', answer: 'Do not miss Wat Pho, Wat Arun, a Chao Phraya boat ride, Yaowarat street food, Thai massage and at least one market such as Chatuchak or Or Tor Kor.' },
      { question: 'How much does 3 days in Bangkok cost?', answer: 'Budget travellers can spend ₹8,000–15,000 excluding flights and accommodation upgrades. A comfortable three-day Bangkok stay usually costs ₹20,000–35,000 with a private room, restaurants and paid attractions.' },
    ],
  },

  {
    slug: 'krabi-travel-guide',
    title: 'Krabi Travel Guide 2025: Beaches, Islands, Costs and Where To Stay',
    excerpt: 'The complete Krabi guide for Thailand travellers — Ao Nang, Railay, Hong Islands, Phi Phi, costs, hotels, transport and what makes Krabi different from Phuket.',
    date: '2025-09-12',
    readTime: 9,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'Where To Stay in Krabi' },
      { type: 'table', headers: ['Base', 'Best For', 'Trade-Off'], rows: [
      ...
      { type: 'h2', text: 'Best Things To Do' },
      { type: 'ol', items: [
        'Take a longtail boat to Railay Beach and Phra Nang Cave Beach.',
        'Book a Hong Islands tour for lagoons, snorkelling and cliff views.',
        'Climb to Tiger Cave Temple if you can handle steep stairs and heat.',
        'Spend sunset at Ao Nang or Railay instead of overpacking the day.',
        'Use Krabi as a base for Phi Phi if you prefer quieter nights than Phuket.',
      ]},
      { type: 'link-cta', text: 'For Maya Bay and snorkelling routes, see the Phi Phi Islands guide.', href: '/blog/phi-phi-islands-guide' },
      { type: 'h2', text: 'Krabi Budget' },
      { type: 'table', headers: ['Category', 'Budget', 'Comfortable'], rows: [
      ...
      { type: 'link-cta', text: 'Build Krabi into a one-week Thailand route.', href: '/blog/thailand-7-day-itinerary' },
      { type: 'h2', text: 'Krabi Travel Tips' },
      { type: 'ul', items: [
    ...
    faqs: [
      { question: 'Is Krabi better than Phuket?', answer: 'Krabi is better for dramatic scenery, quieter beaches, lower costs and longtail boat trips. Phuket is better for flights, nightlife, family infrastructure and hotel variety.' },
      { question: 'How many days do you need in Krabi?', answer: 'Three to four days is ideal for Ao Nang or Railay, one island tour, one slow beach day and Tiger Cave Temple or Krabi Town.' },
      { question: 'What is the best time to visit Krabi?', answer: 'November to April is best for calm seas and island tours. May to October is cheaper but wetter, with rougher seas and possible tour cancellations.' },
      { question: 'Where should first-timers stay in Krabi?', answer: 'Ao Nang is the easiest first-time base because restaurants, hotels, tour operators and boats are all close together.' },
    ],
  },

  {
    slug: 'chiang-mai-travel-guide',
    title: 'Chiang Mai Travel Guide 2025: Temples, Cafes, Markets and Day Trips',
    excerpt: 'A practical guide to Chiang Mai — Old City temples, Doi Suthep, night markets, ethical elephant sanctuaries, cafes, costs and when to avoid smoke season.',
    date: '2025-09-14',
    readTime: 9,
    category: 'Asia',
    tags: ['Chiang Mai', 'Thailand', 'Temples', 'Food', 'Culture', 'Asia'],
    cities: ['chiang-mai'],
    coverPhoto: 'photo-1598970605070-a38a6ccd3a2d',
    content: [
      { type: 'p', text: 'Chiang Mai is Thailand after the volume has been turned down: old city walls, teak temples, mountain air, night markets, coffee shops and some of the country\'s best cooking classes. It is the right Thailand base if you want culture and food more than beaches.' },
      { type: 'link-cta', text: 'Use Chiang Mai as the northern swap in the Thailand 7-day itinerary.', href: '/blog/thailand-7-day-itinerary' },
      { type: 'h2', text: 'Top Chiang Mai Experiences' },
      { type: 'ol', items: [
        'Visit Wat Phra That Doi Suthep in the morning before crowds build.',
        'Walk the Old City temples: Wat Chedi Luang, Wat Phra Singh and smaller quiet temples.',
        'Take a Thai cooking class with a market visit.',
        'Spend an evening at the Sunday Walking Street or Night Bazaar.',
        'Visit an ethical elephant sanctuary that does not offer riding or forced performances.',
      ]},
      { type: 'h2', text: 'Where To Stay' },
      { type: 'table', headers: ['Area', 'Best For', 'Notes'], rows: [
      ...
      { type: 'h2', text: 'Budget and Costs' },
      { type: 'p', text: 'Chiang Mai is cheaper than Bangkok, Phuket and Koh Samui. Budget rooms often start around ₹1,200–2,500 per night, good boutique stays sit around ₹3,500–7,000 and excellent local meals are easy under ₹300.' },
      { type: 'link-cta', text: 'Compare costs across Thailand in the budget guide.', href: '/blog/thailand-budget-travel-guide' },
      { type: 'h2', text: 'When To Visit Chiang Mai' },
      { type: 'p', text: 'November to February is the best window: cool mornings, clearer skies and comfortable walking weather. Late February to April can bring smoke from regional burning, so check air quality before booking if you are sensitive.' },
      { type: 'link-cta', text: 'Read the month-by-month Thailand weather guide before choosing dates.', href: '/blog/best-time-to-visit-thailand' },
    ],
    faqs: [
      { question: 'Is Chiang Mai worth visiting on a Thailand trip?', answer: 'Yes, Chiang Mai is worth visiting if you want temples, food, cafes, mountains and a slower pace. Skip it on a one-week trip only if beaches are your main priority.' },
      { question: 'How many days do you need in Chiang Mai?', answer: 'Three days is enough for Doi Suthep, Old City temples, a cooking class and a night market. Four or five days allows a slower pace and day trips.' },
      { question: 'When should I avoid Chiang Mai?', answer: 'Avoid late February to April if smoke season and air quality are concerns. November to February is usually the most pleasant period.' },
      { question: 'Are elephant sanctuaries in Chiang Mai ethical?', answer: 'Some are, many are not. Avoid any sanctuary offering riding, tricks or bathing sessions designed mainly for tourist photos. Look for rescue-focused operations with clear welfare policies.' },
    ],
  },

  {
    slug: 'koh-samui-travel-guide',
    title: 'Koh Samui Travel Guide 2025: Beaches, Resorts, Weather and Costs',
    excerpt: 'Koh Samui planning guide — best beaches, where to stay, weather differences, costs, island hopping, honeymoon tips and how it compares with Phuket and Krabi.',
    date: '2025-09-16',
    readTime: 8,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Areas in Koh Samui' },
      { type: 'table', headers: ['Area', 'Best For', 'Vibe'], rows: [
        ['Chaweng', 'Nightlife and first-timers', 'Busy, developed, lots of restaurants'],
        ['Lamai', 'Value and beach days', 'Calmer than Chaweng, still convenient'],
        ['Bophut', 'Families and couples', 'Fisherman\'s Village, boutique feel'],
        ['Maenam', 'Quiet stays', 'Long beach, fewer crowds'],
      ]},
      { type: 'h2', text: 'Things To Do' },
      { type: 'ul', items: [
        'Visit Ang Thong Marine Park for lagoons, kayaking and viewpoints.',
        'Spend an evening at Fisherman\'s Village in Bophut.',
        'Take a day trip to Koh Tao for snorkelling or diving.',
        'See Big Buddha and Wat Plai Laem early before the heat.',
        'Book a spa or wellness day; Samui is built for slower travel.',
      ]},
      { type: 'h2', text: 'Weather' },
      { type: 'p', text: 'Koh Samui often works better than Phuket or Krabi in parts of July and August, but October and November can be wet. For the safest weather, choose February to April or June to August with realistic expectations.' },
      { type: 'link-cta', text: 'Check the full Thailand weather guide before picking an island.', href: '/blog/best-time-to-visit-thailand' },
      { type: 'h2', text: 'Budget' },
      { type: 'p', text: 'Koh Samui is usually more expensive than Krabi and often less convenient than Phuket because flights can cost more. Budget travellers can manage with guesthouses and local restaurants, but Samui is strongest for mid-range and resort trips.' },
    ],
    faqs: [
      { question: 'Is Koh Samui better than Phuket?', answer: 'Koh Samui is better for couples, calmer resorts and Gulf-coast weather windows. Phuket is better for flight access, nightlife, family infrastructure and a wider budget range.' },
      { question: 'What is the best time to visit Koh Samui?', answer: 'February to April is usually excellent. June to August can also work well. October and November are often the wettest months on the Koh Samui side.' },
      { question: 'How many days do you need in Koh Samui?', answer: 'Three to five days is ideal, depending on whether you add Ang Thong Marine Park, Koh Tao or a slower resort stay.' },
      { question: 'Is Koh Samui good for honeymoon?', answer: 'Yes. Koh Samui is one of Thailand\'s best honeymoon islands because it has polished resorts, beach clubs, spas, quieter areas and easy romantic dining.' },
    ],
  },

  {
    slug: 'phi-phi-islands-guide',
    title: 'Phi Phi Islands Guide 2025: Maya Bay, Tours, Costs and What To Skip',
    excerpt: 'Plan a Phi Phi Islands trip from Phuket or Krabi — Maya Bay rules, boat options, costs, snorkelling, viewpoints, crowds and the mistakes first-timers make.',
    date: '2025-09-18',
    readTime: 8,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'How To Visit Phi Phi' },
      { type: 'table', headers: ['Option', 'Best For', 'Trade-Off'], rows: [
        ['Shared speedboat day trip', 'Most travellers', 'Efficient but crowded'],
        ['Private longtail from Phi Phi Don', 'Flexible travellers', 'Requires overnight stay'],
        ['Private speedboat', 'Groups and premium trips', 'Expensive but best control'],
        ['Ferry', 'Budget transfers', 'Slow and not ideal for sightseeing'],
      ]},
      { type: 'h2', text: 'Main Stops' },
      { type: 'ul', items: [
        'Maya Bay: beautiful but controlled; swimming rules can change for conservation.',
        'Pileh Lagoon: emerald water surrounded by cliffs, best early.',
        'Viking Cave: usually viewed from the boat.',
        'Monkey Beach: skip close contact with monkeys and keep food hidden.',
        'Phi Phi Viewpoint: best if staying overnight on Phi Phi Don.',
      ]},
      { type: 'h2', text: 'Costs' },
      { type: 'p', text: 'Shared speedboat tours usually cost ₹3,500–7,000 depending on season, inclusions and departure point. Private boats cost much more but can be worth it for groups who want earlier starts and less crowding.' },
      { type: 'link-cta', text: 'For Phuket planning, read the Phuket travel guide.', href: '/blog/phuket-travel-guide' },
      { type: 'link-cta', text: 'For Krabi planning, read the Krabi travel guide.', href: '/blog/krabi-travel-guide' },
      { type: 'h2', text: 'What To Skip' },
      { type: 'ul', items: [
        'Do not book the cheapest tour without checking boat size and reviews.',
        'Do not feed monkeys or carry loose snacks on Monkey Beach.',
        'Do not expect Maya Bay to be empty in peak season.',
        'Do not schedule Phi Phi on your final day before an international flight.',
      ]},
    ],
    faqs: [
      { question: 'Is Phi Phi worth visiting?', answer: 'Phi Phi is worth visiting for dramatic scenery, Maya Bay and snorkelling if you accept crowds. It is not the right choice if you want quiet, empty beaches.' },
      { question: 'Is it better to visit Phi Phi from Phuket or Krabi?', answer: 'Both work. Phuket has more tour options and hotels, while Krabi can feel simpler and closer depending on the route. Choose based on your main beach base.' },
      { question: 'Can you swim at Maya Bay?', answer: 'Maya Bay rules change for conservation. Swimming may be restricted or controlled, so check current rules before booking and treat the beach as a protected natural site.' },
      { question: 'Should I stay overnight on Phi Phi?', answer: 'Stay overnight only if you want viewpoints, nightlife or more flexible boat timing. For most first-timers, a day trip from Phuket or Krabi is enough.' },
    ],
  },

  {
    slug: 'hidden-places-in-thailand',
    title: 'Hidden Places in Thailand 2025: Quiet Islands, Mountain Towns and Local Escapes',
    excerpt: 'A practical guide to lesser-known Thailand places beyond Bangkok and Phuket — quiet islands, northern towns, national parks and low-crowd coastal bases.',
    date: '2025-09-20',
    readTime: 9,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Hidden Places in Thailand' },
      { type: 'table', headers: ['Place', 'Region', 'Best For'], rows: [
      ...
      { type: 'h2', text: 'How To Add Them Without Breaking Your Itinerary' },
      { type: 'p', text: 'Hidden places work best when they replace a crowded stop rather than get squeezed into an already busy route. Swap Koh Yao Noi for one Phuket night, Koh Lanta for one Krabi night, or Mae Kampong for a Chiang Mai day trip. Do not add all of them to a first Thailand trip.' },
      { type: 'link-cta', text: 'For a realistic first route, start with the Thailand 7-day itinerary.', href: '/blog/thailand-7-day-itinerary' },
      { type: 'h2', text: 'Who Should Skip Hidden Thailand?' },
      { type: 'ul', items: [
      ...
      { type: 'link-cta', text: 'If islands are the priority, use the hidden islands guide.', href: '/blog/hidden-islands-in-thailand' },
    ],
    faqs: [
      { question: 'What is the most underrated place in Thailand?', answer: 'Koh Yao Noi is one of Thailand\'s most underrated places because it sits between Phuket and Krabi but feels far quieter, with cycling routes, sea views and small-scale stays.' },
      { question: 'Are hidden places in Thailand safe?', answer: 'Yes, most are safe, but they require more planning around transport, weather and medical access. Keep routes simple and avoid remote islands during rough-sea periods.' },
      { question: 'Can first-timers visit hidden places in Thailand?', answer: 'First-timers can add one quieter place, such as Koh Lanta or Koh Yao Noi, but should still keep Bangkok and one easy beach base in the plan.' },
      { question: 'Which hidden Thailand place is best near Chiang Mai?', answer: 'Mae Kampong is a good low-effort escape near Chiang Mai, known for forest stays, cafes and cooler mountain air.' },
    ],
  },

  {
    slug: 'hidden-islands-in-thailand',
    title: 'Hidden Islands in Thailand 2025: Quiet Alternatives to Phuket and Phi Phi',
    excerpt: 'The best lesser-known Thai islands for beaches without the biggest crowds — Koh Yao Noi, Koh Lanta, Koh Kood, Koh Mak, Trang islands and more.',
    date: '2025-09-22',
    readTime: 9,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'table', headers: ['Island', 'Best For', 'Access'], rows: [
        ['Koh Yao Noi', 'Couples, quiet resorts, cycling', 'Boat from Phuket or Krabi'],
        ['Koh Lanta', 'Families, long stays, calm beaches', 'Road/ferry from Krabi'],
        ['Koh Kood', 'Clear water, quiet luxury', 'Bus/boat via Trat'],
        ['Koh Mak', 'Slow travel, cycling, low nightlife', 'Boat via Trat'],
        ['Koh Mook', 'Emerald Cave, Trang island hopping', 'Boat from Trang coast'],
        ['Koh Phayam', 'Rustic stays, no big-resort feel', 'Boat from Ranong'],
      ]},
      { type: 'link-cta', text: 'For mainstream island planning, compare Phuket and Krabi first.', href: '/blog/phuket-vs-krabi' },
      { type: 'h2', text: 'Best Island by Travel Style' },
      { type: 'ul', items: [
        'Best easy quiet island: Koh Yao Noi.',
        'Best family-friendly quiet island: Koh Lanta.',
        'Best clear-water escape: Koh Kood.',
        'Best low-key backpacker feel: Koh Phayam.',
        'Best island-hopping add-on from Krabi: Koh Mook and the Trang islands.',
      ]},
      { type: 'h2', text: 'Weather Warning' },
      { type: 'p', text: 'Hidden islands are more weather-sensitive than big bases. Boats can be cancelled, medical access is thinner and small resorts may close in low season. November to April is safest for Andaman islands; check Gulf and eastern island weather separately.' },
      { type: 'link-cta', text: 'Check Thailand weather by month before booking small-island transfers.', href: '/blog/best-time-to-visit-thailand' },
    ],
    faqs: [
      { question: 'Which Thai island is least crowded?', answer: 'Koh Phayam, Koh Mak and parts of Koh Kood are among the quieter choices, but access and facilities are more limited than Phuket or Koh Samui.' },
      { question: 'Which hidden island is easiest from Phuket?', answer: 'Koh Yao Noi is one of the easiest quiet-island escapes from Phuket, reached by boat and still close to Phang Nga Bay scenery.' },
      { question: 'Are hidden islands in Thailand good for families?', answer: 'Koh Lanta is the safest hidden-ish island choice for families because it has calmer infrastructure, longer beaches and better access than more remote islands.' },
      { question: 'When should I avoid small Thai islands?', answer: 'Avoid remote island transfers during rough monsoon periods, especially when travelling with children or tight flight connections.' },
    ],
  },

  {
    slug: 'thailand-in-december',
    title: 'Thailand in December 2025: Weather, Crowds, Costs and Best Places',
    excerpt: 'What Thailand is really like in December — beach weather, peak-season prices, Christmas and New Year crowds, best islands and booking tips.',
    date: '2025-09-24',
    readTime: 8,
    category: 'Planning',
    ...
    content: [
      ...
      { type: 'h2', text: 'December Weather' },
      { type: 'table', headers: ['Place', 'December Outlook', 'Best For'], rows: [
        ['Bangkok', 'Warm, drier, manageable humidity', 'Temples, food, shopping'],
        ['Phuket', 'Excellent beach weather', 'Families, island tours, first-timers'],
        ['Krabi', 'Excellent beach weather', 'Railay, Hong Islands, Phi Phi'],
        ['Chiang Mai', 'Cool mornings, dry skies', 'Temples, markets, mountain trips'],
        ['Koh Samui', 'Improving but can still be wet early', 'Resorts with flexible plans'],
      ]},
      { type: 'h2', text: 'December Costs' },
      { type: 'p', text: 'Flights, beach hotels and island tours are all in high demand. The most expensive window is roughly 20 December to 5 January. Book refundable hotels early, and do not leave domestic flights to the last minute.' },
      { type: 'link-cta', text: 'Use the Thailand budget guide to plan peak-season costs.', href: '/blog/thailand-budget-travel-guide' },
      { type: 'h2', text: 'Best December Route' },
      { type: 'p', text: 'Bangkok plus Phuket or Krabi is the safest December route. Chiang Mai is excellent too if you want cooler weather and culture. Koh Samui can work, but the Andaman side is usually the safer beach bet in December.' },
      { type: 'link-cta', text: 'Build December into a practical one-week route.', href: '/blog/thailand-7-day-itinerary' },
    ],
    faqs: [
      { question: 'Is December a good time to visit Thailand?', answer: 'Yes. December is one of the best months for Thailand weather, especially Bangkok, Phuket, Krabi and Chiang Mai. It is also one of the busiest and most expensive periods.' },
      { question: 'Is Thailand crowded in December?', answer: 'Yes, especially around Christmas and New Year. Beaches, island tours and popular hotels should be booked well ahead.' },
      { question: 'Which Thai island is best in December?', answer: 'Phuket and Krabi are safer December choices than Koh Samui because the Andaman coast is usually in dry season.' },
      { question: 'Is Thailand expensive in December?', answer: 'Thailand becomes noticeably more expensive in December, especially beach hotels and flights near Christmas and New Year.' },
    ],
  },

  {
    slug: 'thailand-in-monsoon',
    title: 'Thailand in Monsoon 2025: Where To Go, What To Avoid and Is It Worth It?',
    excerpt: 'A realistic Thailand monsoon guide — rainy months, which coast to choose, when Phuket gets rough, Koh Samui weather, costs and flexible itinerary tips.',
    date: '2025-09-26',
    readTime: 8,
    category: 'Planning',
    ...
    content: [
      ...
      { type: 'h2', text: 'Monsoon at a Glance' },
      { type: 'table', headers: ['Period', 'What To Expect', 'Better Bets'], rows: [
      ...
      { type: 'h2', text: 'Where To Go in Monsoon' },
      { type: 'p', text: 'Bangkok works year-round if you plan around showers. Chiang Mai is green and cheaper, though rain affects day trips. Koh Samui often has better odds than Phuket and Krabi during parts of July and August.' },
      { type: 'link-cta', text: 'For Gulf-island planning, read the Koh Samui guide.', href: '/blog/koh-samui-travel-guide' },
      ...
      { type: 'link-cta', text: 'If beach weather matters most, compare Phuket and Krabi before booking.', href: '/blog/phuket-vs-krabi' },
    ],
    faqs: [
      { question: 'Is Thailand worth visiting in monsoon?', answer: 'Thailand can be worth visiting in monsoon if you want lower prices, fewer crowds and flexible city or food-focused travel. It is riskier for beach and island-tour holidays.' },
      { question: 'Which part of Thailand is best in monsoon?', answer: 'Bangkok and Chiang Mai can work year-round. For beaches, Koh Samui and the Gulf islands often have better odds than Phuket and Krabi during parts of July and August.' },
      { question: 'What is the wettest month in Thailand?', answer: 'September is often one of the wettest and least reliable months for many Thailand routes.' },
      { question: 'Is Phuket safe in monsoon?', answer: 'Phuket is visitable in monsoon, but swimming can be dangerous when red flags are up and island tours may be cancelled due to rough seas.' },
    ],
  },

  {
    slug: 'phuket-vs-krabi',
    title: 'Phuket vs Krabi 2025: Which Thailand Beach Destination Is Better?',
    excerpt: 'A clear Phuket vs Krabi comparison for first-time Thailand travellers — beaches, costs, flights, nightlife, family travel, island tours and who should choose which.',
    date: '2025-09-28',
    readTime: 9,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'table', headers: ['Choose Phuket If', 'Choose Krabi If'], rows: [
        ['You want frequent flights and easy logistics', 'You want dramatic scenery and quieter beaches'],
        ['You are travelling with family or first-timers', 'You prefer lower-key evenings'],
        ['Nightlife and hotel choice matter', 'Railay, Hong Islands and cliffs matter'],
        ['You want more restaurants and shopping', 'You want better value and simpler beach days'],
      ]},
      { type: 'link-cta', text: 'Read the full Phuket guide for beaches, day trips and costs.', href: '/blog/phuket-travel-guide' },
      { type: 'link-cta', text: 'Read the full Krabi guide for Ao Nang, Railay and island tours.', href: '/blog/krabi-travel-guide' },
      { type: 'h2', text: 'Cost Comparison' },
      { type: 'p', text: 'Krabi is usually cheaper for guesthouses, local food and simpler beach days. Phuket can be good value outside peak season, but taxis, resorts and nightlife raise the average spend quickly.' },
      { type: 'h2', text: 'Island Tours' },
      { type: 'p', text: 'Both bases can reach Phi Phi. Phuket has more operators and premium options; Krabi has easier access to Railay and Hong Islands. If Phi Phi is the only must-do, choose based on flights and hotel style rather than distance alone.' },
      { type: 'link-cta', text: 'Plan Maya Bay and snorkelling with the Phi Phi Islands guide.', href: '/blog/phi-phi-islands-guide' },
      { type: 'h2', text: 'Final Recommendation' },
      { type: 'p', text: 'For a first Thailand trip with family, nightlife or anxiety about logistics, choose Phuket. For couples, budget travellers and scenery-first visitors, choose Krabi. For ten days or more, do both only if you avoid overpacking other regions.' },
      { type: 'link-cta', text: 'Fit either beach base into the Thailand 7-day itinerary.', href: '/blog/thailand-7-day-itinerary' },
    ],
    faqs: [
      { question: 'Is Phuket or Krabi better for first-timers?', answer: 'Phuket is easier for first-timers because flights, hotels, restaurants and tours are more developed. Krabi is better if you want quieter scenery and simpler beach days.' },
      { question: 'Is Krabi cheaper than Phuket?', answer: 'Krabi is generally cheaper for accommodation, local food and transport. Phuket has more budget options overall but also more ways to overspend.' },
      { question: 'Which has better beaches, Phuket or Krabi?', answer: 'Krabi has more dramatic scenery around Railay and nearby islands. Phuket has more accessible beaches with better facilities and hotel choice.' },
      { question: 'Can I visit Phi Phi from both Phuket and Krabi?', answer: 'Yes. Phi Phi day trips operate from both Phuket and Krabi, so choose your base based on overall trip style rather than Phi Phi alone.' },
    ],
  },

  {
    slug: 'bangkok-vs-phuket',
    title: 'Bangkok vs Phuket 2025: Which Should You Visit First in Thailand?',
    excerpt: 'Bangkok vs Phuket for first-time Thailand travellers — culture, beaches, food, nightlife, costs, family travel and the smartest way to combine both.',
    date: '2025-09-30',
    readTime: 8,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'Quick Comparison' },
      { type: 'table', headers: ['Factor', 'Bangkok', 'Phuket'], rows: [
        ['Best for', 'Food, temples, shopping, culture', 'Beaches, island tours, resorts'],
        ['Typical stay', '2–3 nights', '3–5 nights'],
        ['Costs', 'Cheaper transport and food', 'Higher taxis and beach hotels'],
        ['Transport', 'BTS, MRT, boats, Grab', 'Taxis, scooters, tours, limited public options'],
        ['Family fit', 'Good but busy', 'Very strong in Kata, Karon and resort areas'],
      ]},
      { type: 'link-cta', text: 'Plan the city portion with the Bangkok 3-day itinerary.', href: '/blog/bangkok-3-day-itinerary' },
      { type: 'link-cta', text: 'Plan the beach portion with the Phuket travel guide.', href: '/blog/phuket-travel-guide' },
      { type: 'h2', text: 'Which Should You Visit First?' },
      { type: 'p', text: 'Start in Bangkok. International flights are usually cheaper, jet lag is easier to handle in the city and the temples, food and shopping give Thailand context before the beach. End in Phuket if you want the trip to slow down before flying home.' },
      { type: 'h2', text: 'When To Skip One' },
      { type: 'ul', items: [
        'Skip Phuket if your trip is only four days and you care more about food and temples.',
        'Skip Bangkok only if you are flying directly to Phuket for a pure resort holiday.',
        'Skip both together if you have less than six days and hate domestic flights.',
      ]},
      { type: 'link-cta', text: 'Use both in the full Thailand 7-day itinerary.', href: '/blog/thailand-7-day-itinerary' },
    ],
    faqs: [
      { question: 'Is Bangkok or Phuket better?', answer: 'Bangkok is better for food, temples, culture and shopping. Phuket is better for beaches, resorts and island tours. Most first-time Thailand trips should include both.' },
      { question: 'Should I go to Bangkok before Phuket?', answer: 'Yes, Bangkok first usually works best because flights are cheaper, the city gives cultural context and Phuket makes a relaxing finish.' },
      { question: 'Is Phuket more expensive than Bangkok?', answer: 'Phuket is usually more expensive for taxis, beach hotels and tours. Bangkok is cheaper for public transport and street food.' },
      { question: 'How many days do I need for Bangkok and Phuket?', answer: 'Seven days works well: three nights in Bangkok and four nights in Phuket.' },
    ],
  },

  {
    slug: 'thailand-honeymoon-guide',
    title: 'Thailand Honeymoon Guide 2025: Best Islands, Resorts and Romantic Itinerary',
    excerpt: 'Plan a Thailand honeymoon with the right island, season and route — Phuket, Krabi, Koh Samui, Bangkok, costs, romantic stays and mistakes to avoid.',
    date: '2025-10-02',
    readTime: 10,
    category: 'Asia',
    ...
    content: [
      ...
      { type: 'h2', text: 'Best Honeymoon Bases' },
      { type: 'table', headers: ['Base', 'Best For', 'When It Works Best'], rows: [
        ['Phuket', 'Easy luxury, flights, beach resorts', 'November to April'],
        ['Krabi / Railay', 'Scenery, cliffs, quieter romance', 'November to April'],
        ['Koh Samui', 'Resorts, spas, relaxed couples', 'February to September'],
        ['Bangkok', 'Food, shopping, rooftop dinners', 'Year-round short stay'],
      ]},
      { type: 'h2', text: '7-Day Honeymoon Route' },
      { type: 'table', headers: ['Day', 'Base', 'Plan'], rows: [
        ['Day 1', 'Bangkok', 'Arrive, riverside dinner, early night'],
        ['Day 2', 'Bangkok', 'Temples, massage, rooftop drinks'],
        ['Day 3', 'Phuket/Krabi/Samui', 'Fly to island, sunset beach dinner'],
        ['Day 4', 'Island base', 'Private tour, spa or slow beach day'],
        ['Day 5', 'Island base', 'Boat trip or viewpoint day'],
        ['Day 6', 'Island base', 'No hard plans; keep this as the relaxed day'],
        ['Day 7', 'Depart', 'Fly home or connect via Bangkok'],
      ]},
      { type: 'link-cta', text: 'Compare Phuket and Krabi for the beach portion.', href: '/blog/phuket-vs-krabi' },
      { type: 'link-cta', text: 'For a Gulf-coast honeymoon, read the Koh Samui guide.', href: '/blog/koh-samui-travel-guide' },
      { type: 'h2', text: 'Budget' },
      { type: 'p', text: 'A comfortable Thailand honeymoon usually costs ₹1.2–2.5 lakh per couple excluding major luxury splurges, depending on flights, resort category and private tours. Phuket and Koh Samui can be pricier; Krabi often gives better value for scenery.' },
      { type: 'h2', text: 'Mistakes To Avoid' },
      { type: 'ul', items: [
        'Do not change islands every two nights; it turns the honeymoon into logistics.',
        'Do not book the wrong coast for your travel month.',
        'Do not rely on the cheapest island tour for a special day.',
        'Do not skip Bangkok entirely if you enjoy food, hotels and rooftop evenings.',
      ]},
      { type: 'link-cta', text: 'Compare Thailand with Bali if you are choosing between honeymoon destinations.', href: '/blog/bali-vs-thailand-indian-travellers' },
    ],
    faqs: [
      { question: 'Is Thailand good for honeymoon?', answer: 'Yes. Thailand is excellent for honeymoons because it combines beach resorts, private villas, spas, food, easy flights and strong value compared with many long-haul island destinations.' },
      { question: 'Which is the best Thailand island for honeymoon?', answer: 'Koh Samui is best for polished resort honeymoons, Phuket is best for convenience and luxury choice, and Krabi is best for dramatic scenery and quieter romance.' },
      { question: 'How many days are enough for a Thailand honeymoon?', answer: 'Seven to ten days is ideal. Spend two nights in Bangkok and the rest on one island or beach base rather than changing places constantly.' },
      { question: 'Is Thailand or Bali better for honeymoon?', answer: 'Thailand is better for island variety, food and easier visa-free entry for Indians. Bali is better for villas, Hindu cultural familiarity and a one-island romantic trip.' },
    ],
  },
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Visa-free/on-arrival countries for Indians include Thailand for short tourist visits under visa-exemption rules, Nepal (unlimited), Bhutan (e-Permit required), Sri Lanka (free ETA), Maldives (30 days on arrival), Mauritius (90 days), Indonesia/Bali (30 days VOA), UAE/Dubai under specific eligibility conditions, and around 60 other countries. Always verify current rules before booking.",
      },
      {
  ...
  // ── VIETNAM ITINERARIES ────────────────────────────────────────────────────
  {
    ...
    cities: ['ho-chi-minh-city', 'hanoi', 'hoi-an'],
    coverPhoto: 'photo-1559592413-7cec4d0cae2b',
    citySlug: 'ho-chi-minh-city',
    content: [
      { type: 'p', text: 'Vietnam is Southeast Asia\'s most rewarding bargain — ancient temple towns, UNESCO coastlines, and some of the world\'s best street food, all accessible on a straightforward Indian e-visa. This 6-day itinerary takes you from Hanoi\'s French-colonial boulevards to Hoi An\'s lantern-lit Ancient Town, finishing in the electric chaos of Ho Chi Minh City. North to south in six days: it\'s tight, but it captures Vietnam\'s full personality.' },
      { type: 'callout', emoji: '🛂', text: 'Visa: Vietnam e-visa costs $25 (≈₹2,100). Apply at evisa.gov.vn — approval in 3–5 working days. Valid 90 days, multiple entry. Apply 2 weeks before travel to be safe.' },
      { type: 'h2', text: 'Days 1–2: Hanoi — Old Quarter, Egg Coffee & Ha Long Bay' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1509030450996-dd1a26dda07a?auto=format&fit=crop&w=800&q=80', alt: 'Hanoi Old Quarter street at night', caption: 'Hanoi Old Quarter — 36 guild streets, lantern-lit alleys, egg coffee at sunset' },
      { type: 'h3', text: 'Day 1 — Hanoi Arrival & Old Quarter' },
      { type: 'p', text: 'Morning: Arrive at Noi Bai Airport (Grab car to Old Quarter ≈₹1,000, 40 min). Walk Hoan Kiem Lake at dawn — locals do tai chi on the shore. Cross the red Huc Bridge to the 15th-century Ngoc Son Temple on a lake island.' },
      { type: 'p', text: 'Afternoon: Ba Dinh district — Ho Chi Minh Mausoleum complex (Tue–Thu + Sat–Sun mornings, free), One Pillar Pagoda, and the Temple of Literature (₫30,000 / ₹110), Vietnam\'s first university founded in 1070 — one of the best-preserved traditional Vietnamese architectural complexes anywhere.' },
      { type: 'p', text: 'Evening: Get lost in the Old Quarter\'s 36 streets. Dinner at Bun Cha Huong Lien — the "Obama restaurant" where the US President ate in 2016 (₫80,000 / ₹300). Egg coffee at Cafe Giang (Nguyen Huu Huan St) — thick whipped egg yolk over espresso, ₫30,000. End at Ta Hien Beer Corner for bia hoi (fresh draught beer, ₫5,000 / ₹18 a glass).' },
      { type: 'callout', emoji: '💡', text: 'Hanoi tip: Grab app is essential — motorbike Grab across the Old Quarter costs ₹110–220. Never take unmetered taxis from the airport.' },
      { type: 'h3', text: 'Day 2 — Ha Long Bay Day Cruise' },
      { type: 'p', text: 'Depart Hanoi 7:30am by tourist shuttle (₹800–900 one way, book through hotel). 3.5-hour drive to Ha Long Bay. Board a day cruise — UNESCO limestone karsts rising 200m from emerald water, kayaking through sea caves at Luon Cave, swimming at a floating fishing village, lunch onboard (spring rolls, grilled fish, morning glory), visit Sung Sot Cave (Cave of Surprises). Return Hanoi by 7:30pm.' },
      { type: 'callout', emoji: '💰', text: 'Ha Long Bay day cruise: ₹2,500–5,000 per person including lunch and cave entry. Overnight cruises are more relaxed but this itinerary uses the day version to save a night.' },
      { type: 'link-cta', text: 'Full Hanoi guide: top attractions, best restaurants, neighbourhoods and budget breakdown.', href: '/cities/hanoi' },
      { type: 'divider' },
      { type: 'h2', text: 'Days 3–4: Hoi An — Ancient Town, Lanterns & Tailors' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80', alt: 'Hoi An Ancient Town lanterns at night', caption: 'Hoi An after dark — silk lanterns, floating candles on the Thu Bon River' },
      { type: 'h3', text: 'Day 3 — Arrival in Hoi An' },
      { type: 'p', text: 'Morning: Fly Hanoi → Da Nang (1 hr, ₹1,500–4,000 on VietJet / Bamboo, book 4–6 weeks ahead). Grab to Hoi An (45 min, ₹800). Check in near the Ancient Town.' },
      { type: 'p', text: 'Afternoon: Hoi An Ancient Town (UNESCO). Entry combo ticket ₫120,000 (₹440) covers 5 sites: iconic 400-year-old Japanese Covered Bridge, Tan Ky Old House (Japanese-Chinese fusion architecture), Fujian Assembly Hall, and two more heritage buildings. Walk the riverside promenade.' },
      { type: 'p', text: 'Evening: Hoi An at night is one of Asia\'s great experiences — hundreds of silk lanterns glow above the Ancient Town streets, the Thu Bon River shimmers with floating candle boats. Buy a paper lantern (₹110), light it, float it. Dinner: Banh Mi Phuong (world-famous banh mi, ₹90) and a sit-down meal at Mango Rooms on the riverside.' },
      { type: 'callout', emoji: '✂️', text: 'Order tailor-made clothing on Day 3 morning, collect Day 4 evening. Yaly Couture and A Dong Silk are the most reliable — custom ao dai ₹2,500–4,500, custom suit ₹5,000–9,000.' },
      { type: 'h3', text: 'Day 4 — Cooking Class, Coconut Forest & Beaches' },
      { type: 'p', text: 'Morning: Hoi An cooking class (₹1,800–2,500 including a guided Thu Bon riverside market visit). Learn cao lau noodles (made only with water from Hoi An\'s 1,000-year-old wells), white rose dumplings (banh vac), and banh xeo crispy pancakes. Lunch is what you cook.' },
      { type: 'p', text: 'Afternoon: Basket boat (coracle) tour at Cam Thanh Coconut Village (₹1,100). Circular woven bamboo boats navigate a dense water-coconut forest; your guide spins the boat. Includes crab fishing and fresh coconut water.' },
      { type: 'p', text: 'Evening: Collect tailor order. Stroll Ancient Town one last time. Street food binge: cao lau (₹180), white rose (₹150), fresh spring rolls (₹90). Board the night train or early morning flight to Ho Chi Minh City.' },
      { type: 'divider' },
      { type: 'h2', text: 'Days 5–6: Ho Chi Minh City — War History, Street Food & Mekong' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?auto=format&fit=crop&w=800&q=80', alt: 'Ho Chi Minh City street scene', caption: 'HCMC — 9 million motorbikes, colonial-era postcards, and the world\'s best street food' },
      { type: 'h3', text: 'Day 5 — HCMC: War History & Colonial Circuit' },
      { type: 'p', text: 'Morning: Fly Da Nang → HCMC (1.5 hrs, ₹1,500–3,500). Go directly to the War Remnants Museum (₫40,000 / ₹150, 2–3 hrs) — three floors of photographs, US military equipment, and Agent Orange documentation. One of the most powerful war museums in the world, presented from the Vietnamese perspective.' },
      { type: 'p', text: 'Afternoon: District 1 colonial circuit — all within 500m: Reunification Palace (where the Vietnam War ended on 30 April 1975, tanks crashed through these gates), Saigon Central Post Office (Eiffel\'s team designed it, still operating), Notre-Dame Cathedral. Ben Thanh Market for souvenirs at local prices.' },
      { type: 'p', text: 'Evening: Rooftop bar sunset — Chill Sky Bar (49th floor, ₹730 cover), or EON Heli Bar at Bitexco Tower. Then Nguyen Hue Walking Street for the city\'s evening crowds.' },
      { type: 'h3', text: 'Day 6 — Cu Chi Tunnels + Departure' },
      { type: 'p', text: 'Morning: Cu Chi Tunnels day trip (departs 8am, returns 2pm, ₹1,800–2,800 including transport). The 250km Viet Cong underground tunnel network used during the Vietnam War — you can crawl through original tunnels, see booby trap demonstrations, and fire an AK-47 at the shooting range. Return to HCMC by 2pm.' },
      { type: 'p', text: 'Afternoon: Final wander around Ben Thanh Market for last-minute gifts. Bui Vien Walking Street for HCMC\'s most chaotic and colourful street food evening. Then Tan Son Nhat Airport (6km from District 1, Grab ≈₹360, allow 2–3 hours before flight).' },
      { type: 'callout', emoji: '✈️', text: 'Return flights: IndiGo, VietJet, and Air India fly HCMC–India (Mumbai, Delhi, Chennai, Bengaluru). Book 6–8 weeks ahead for under ₹12,000 one-way.' },
      { type: 'link-cta', text: 'Full Ho Chi Minh City guide: day trips, restaurants, nightlife and what to skip.', href: '/cities/ho-chi-minh-city' },
      { type: 'divider' },
      { type: 'h2', text: 'Vietnam 6-Day Budget (Per Person from India)' },
      ...
      { type: 'h2', text: 'Essential Tips for Indians' },
      { type: 'ul', items: [
      ...
      { type: 'link-cta', text: 'Vietnam country page: all cities, visa info, best time, and complete travel planning.', href: '/countries/vietnam' },
    ],
    faqs: [
      { question: 'Is 6 days enough for Vietnam?', answer: '6 days covers the essential north-to-south highlights perfectly — Hanoi, Hoi An, and Ho Chi Minh City. You won\'t have time for Ha Long Bay overnight cruise or Sapa, but you\'ll see Vietnam\'s full personality. For more depth, 10 days is ideal.' },
      { question: 'How much does a 6-day Vietnam trip cost from India?', answer: 'Budget ₹33,000–57,000 per person (including flights). Mid-range ₹57,000–98,000. Vietnam is comparable to Thailand in cost and cheaper than Bali for most categories.' },
      { question: 'Do Indians need a visa for Vietnam?', answer: 'Yes. Indian passport holders need a Vietnam e-visa ($25 / ₹2,100). Apply at evisa.gov.vn — approved in 3–7 working days. Valid 90 days, multiple entry.' },
      { question: 'What cities does a 6-day Vietnam itinerary cover?', answer: 'A 6-day Vietnam itinerary covers Hanoi (days 1–2) with its Old Quarter and egg coffee, Hoi An (days 3–4) for the lantern-lit Ancient Town and tailors, and Ho Chi Minh City (days 5–6) for war history, street food and the Mekong.' },
    ],
  },

  {
    ...
    cities: ['hanoi', 'ho-chi-minh-city', 'hoi-an'],
    coverPhoto: 'photo-1583417319070-4a69db38a482',
    citySlug: 'hanoi',
    content: [
      { type: 'p', text: 'Seven days is the sweet spot for Vietnam — enough time to do Hanoi justice with a proper Ha Long Bay overnight cruise, experience Hoi An at full depth, and spend two days in Ho Chi Minh City including the Mekong Delta. This itinerary is the most popular Vietnam route for Indian travellers, balancing culture, history, nature, and street food from north to south.' },
      { type: 'callout', emoji: '🛂', text: 'Visa: Vietnam e-visa $25 (≈₹2,100) at evisa.gov.vn. Approved in 3–5 working days. Valid 90 days, multiple entry. Apply 2 weeks before departure.' },
      { type: 'h2', text: 'Days 1–3: Hanoi — Old Quarter, Culture & Ha Long Bay Cruise' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1509030450996-dd1a26dda07a?auto=format&fit=crop&w=800&q=80', alt: 'Hanoi Old Quarter streets at night', caption: 'Hanoi — thousand-year-old capital of French villas, pho at dawn, and the world\'s best egg coffee' },
      { type: 'h3', text: 'Day 1 — Arrival & Old Quarter' },
      { type: 'p', text: 'Morning: Arrive Noi Bai Airport (Grab car to Old Quarter ≈₹1,000). Walk Hoan Kiem Lake at dawn — locals do tai chi here. Cross Huc Bridge to Ngoc Son Temple. Pho bo breakfast at a street stall (₹90–140).' },
      { type: 'p', text: 'Afternoon: Ho Chi Minh Mausoleum complex (Tue–Thu, Sat–Sun mornings), One Pillar Pagoda, and Temple of Literature. Hoa Lo Prison (the "Hanoi Hilton") — 1.5 hours for a sobering, well-curated museum.' },
      { type: 'p', text: 'Evening: Old Quarter walking street (open Fri–Sun), egg coffee at Cafe Giang (₹110), bun cha (grilled pork noodles, ₹300) at Huong Lien, Ta Hien Beer Corner for bia hoi (₹18/glass). This street food circuit is unmissable.' },
      { type: 'h3', text: 'Day 2 — Ha Long Bay Overnight Cruise' },
      { type: 'p', text: 'Depart 8am by tourist coach (₹800). 3.5-hour drive to Ha Long Bay pier. Board your overnight cruise (2-day/1-night junk boat, ₹8,000–20,000 per person including all meals). Afternoon: sailing through limestone karsts, kayaking through Luon Cave, swimming at floating village. Sunset dinner onboard on the deck, squid fishing after dark, sleeping on the bay.' },
      { type: 'callout', emoji: '⛵', text: 'Book Ha Long Bay cruise at least 3 days ahead in peak season (Oct–Apr). Emeraude Classic and Pelican Cruise are well-reviewed mid-range options (₹10,000–15,000 per person for 2D/1N).' },
      { type: 'h3', text: 'Day 3 — Ha Long Bay Morning + Ninh Binh' },
      { type: 'p', text: 'Morning: Wake on Ha Long Bay for sunrise. Morning kayaking or tai chi on deck. Brunch onboard. Return to Hanoi pier by 12:30pm.' },
      { type: 'p', text: 'Afternoon: Drive 90km south to Ninh Binh (the "Ha Long Bay on Land"). Trang An boat tour (UNESCO World Heritage, ₹550) — rowing through limestone karsts and caves in the flooded valley. Add Mua Cave for a 500-step hilltop panorama at sunset.' },
      { type: 'p', text: 'Evening: Return to Hanoi by 8pm. West Lake cycling or a quiet dinner at a lakeside restaurant. Vietnam Museum of Ethnology if you missed it.' },
      { type: 'link-cta', text: 'Full Hanoi guide: Old Quarter walking routes, best restaurants, Ha Long Bay booking tips.', href: '/cities/hanoi' },
      { type: 'divider' },
      { type: 'h2', text: 'Days 4–5: Hoi An — Lanterns, Tailors & Cooking Classes' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80', alt: 'Hoi An river at night with lanterns', caption: 'Hoi An at night — lantern-lit Ancient Town, floating candle boats, Japan Bridge at dusk' },
      { type: 'h3', text: 'Day 4 — Arrival in Hoi An + Ancient Town' },
      { type: 'p', text: 'Morning: Fly Hanoi → Da Nang (1 hr, ₹1,500–4,000). Grab to Hoi An (45 min, ₹800). Drop bags and head straight to the Ancient Town with combo ticket (₫120,000 / ₹440): Japanese Covered Bridge (1593), Tan Ky Old House, Fujian Assembly Hall, Quan Cong Temple, Tran Family Chapel.' },
      { type: 'p', text: 'Afternoon: Place tailor order at Yaly Couture or A Dong Silk (custom ao dai ₹2,500–4,500). Browse Thu Bon riverside. Visit the Hoi An Museum of History and Culture if you want more context.' },
      { type: 'p', text: 'Evening: Ancient Town after dark is the entire experience. Silk lanterns, floating river candles, Vietnamese families in ao dai. Eat: Cao lau at Thanh Cao Lau (only in Hoi An), white rose dumplings, banh mi from Phuong (the world\'s most famous banh mi). River seat dining at Morning Glory or Streets International.' },
      { type: 'h3', text: 'Day 5 — Cooking Class, Basket Boats & Beaches' },
      { type: 'p', text: 'Morning: Cooking class with Thu Bon market tour (₹1,800–2,500, includes lunch). Learn cao lau, banh xeo, white rose dumplings. Market visit includes interaction with vendors selling fresh herbs, live crabs, morning glory, and banana flower.' },
      { type: 'p', text: 'Afternoon: Basket boat tour at Cam Thanh Coconut Village (₹1,100) or An Bang Beach (8km from town, pristine white sand, ₹220 by xe om motorbike). Collect tailor order in the evening.' },
      { type: 'p', text: 'Evening: Final Ancient Town circuit. Hoi An has some excellent wine bars (Cargo Club, Tam Tam) and a tiny cocktail scene. Local banana flower salad and fresh turmeric fish at a riverside spot before heading out tomorrow.' },
      { type: 'divider' },
      { type: 'h2', text: 'Days 6–7: Ho Chi Minh City — History, Mekong & Street Food' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?auto=format&fit=crop&w=800&q=80', alt: 'Ho Chi Minh City at night', caption: 'HCMC — Southeast Asia\'s most energetic city: history, food, and motorbikes in every direction' },
      { type: 'h3', text: 'Day 6 — HCMC: War History & City Circuit' },
      { type: 'p', text: 'Morning: Fly Da Nang → HCMC (1.5 hrs). War Remnants Museum (₫40,000, 3 hrs) — the most powerful war museum in Southeast Asia. Then: Reunification Palace (tanks crashed through these gates 30 April 1975), Saigon Post Office, Notre-Dame Cathedral, Ben Thanh Market.' },
      { type: 'p', text: 'Evening: Rooftop bar at Chill Sky Bar or EON Heli Bar. Nguyen Hue Walking Street. Dinner in District 1: com tam (broken rice with pork chop, ₹180), bun bo Hue (spicy Hue beef noodles, ₹200), or a craft beer at a rooftop brewpub.' },
      { type: 'h3', text: 'Day 7 — Mekong Delta Day Trip + Departure' },
      { type: 'p', text: 'Morning: Mekong Delta group tour departs 7:30am (returns 5pm, ₹2,000–3,200 including lunch). Speedboat to My Tho, Unicorn Island — coconut candy factory, sampan canal through water palm forest, tropical fruit tasting on a floating farm, fresh seafood lunch.' },
      { type: 'p', text: 'Afternoon: Return to HCMC 5pm. Final Ben Thanh Market sweep for lacquerware, silk, coffee. Bui Vien Walking Street for a last Vietnamese street food pass.' },
      { type: 'p', text: 'Departure: Tan Son Nhat Airport, 6km from District 1. Grab ≈₹360, allow 2–3 hours before international flight.' },
      { type: 'callout', emoji: '✈️', text: 'Flight home: IndiGo, VietJet, Air India fly HCMC to Delhi, Mumbai, Chennai, Bengaluru, Hyderabad. Book 6–8 weeks ahead for fares under ₹12,000 one-way.' },
      { type: 'link-cta', text: 'Full Ho Chi Minh City guide: Cu Chi Tunnels, Mekong, Saigon nightlife and day trips.', href: '/cities/ho-chi-minh-city' },
      { type: 'divider' },
      { type: 'h2', text: 'Vietnam 7-Day Budget Breakdown (Per Person)' },
      { type: 'table', headers: ['Expense', 'Budget ₹', 'Mid-range ₹', 'Notes'], rows: [
        ['Return flights from India', '18,000–30,000', '28,000–45,000', 'Book 6–8 weeks ahead'],
      ...
      { type: 'link-cta', text: 'Vietnam country page: full visa guide, all destinations, and best time to visit.', href: '/countries/vietnam' },
    ],
    faqs: [
      { question: 'Is 7 days enough for Vietnam?', answer: '7 days is the ideal minimum — you can cover Hanoi (with Ha Long Bay), Hoi An, and Ho Chi Minh City at a comfortable pace. To add Sapa trekking or a Mekong Delta overnight, plan for 10–12 days.' },
      { question: 'What is the best route for Vietnam in 7 days?', answer: 'North to south: Hanoi (3 nights) → Hoi An (2 nights) → Ho Chi Minh City (2 nights). Fly between each city on budget airlines VietJet or Bamboo for ₹1,500–4,000 per flight.' },
      { question: 'Do Indians need a visa for Vietnam?', answer: 'Yes. Indian passport holders need a Vietnam e-visa ($25 / ₹2,100), applied for at evisa.gov.vn and approved in 3–7 working days. It is valid for 90 days with multiple entry.' },
      { question: 'How much does a 7-day Vietnam trip cost from India?', answer: 'A 7-day Vietnam trip costs roughly ₹42,000–78,000 per person on a budget and ₹74,000–1,37,000 mid-range, including return flights from India. Vietnam is comparable to Thailand in cost and cheaper than Bali for most categories.' },
    ],
  },
  ...
  // ── JAPAN ITINERARIES ───────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: 'callout', emoji: '🛂', text: 'Visa: Indian passport holders need a Japan tourist visa (Sticker Visa, applied at Japan Consulate / VFS in India). Processing 5–7 working days. Fee ₹550. Requires bank statement, confirmed hotel bookings, and return flight. Apply 3–4 weeks before travel.' },
      { type: 'callout', emoji: '🚆', text: 'JR Pass: Buy a 7-day JR Pass before leaving India (approx ₹26,000). Covers all Shinkansen (bullet trains) and JR lines in Japan. Worth it if your route includes Tokyo–Kyoto–Osaka. Buy at japan-rail-pass.com or through Indian agents.' },
      { type: 'h2', text: 'Days 1–3: Tokyo — Temples, Neon & World-Class Food' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=800&q=80', alt: 'Tokyo city lights at night from above', caption: 'Tokyo — 37 million people, perfectly punctual trains, and ramen at 2am' },
      { type: 'h3', text: 'Day 1 — Asakusa, Shibuya & Shinjuku' },
      { type: 'p', text: 'Morning: Take the Narita Express to Tokyo Station (₹2,800, covered by JR Pass). Head to Asakusa — Tokyo\'s oldest neighbourhood. Senso-ji Temple (free, founded 645 AD) is the city\'s most visited attraction. The Nakamise shopping street leading to it sells traditional snacks, yukata robes, and folding fans.' },
      { type: 'p', text: 'Afternoon: Shibuya Crossing — the world\'s busiest pedestrian intersection, best viewed from the Starbucks window above or the Shibuya Sky observation deck (₹1,600, book online). Harajuku\'s Takeshita Street for Japanese youth fashion and crepe culture. Meiji Shrine in Yoyogi Park (free) — forested Shinto shrine in the middle of Tokyo.' },
      { type: 'p', text: 'Evening: Shinjuku for dinner and drinks. Ramen at Ichiran (solo dining cubicles, ₹850–1,100), Omoide Yokocho ("Memory Lane") for tiny yakitori grills, a Tokyo Skytree or Shinjuku Observation Deck for the city lit up at night (₹1,450).' },
      { type: 'callout', emoji: '🍜', text: 'Food for Indians in Tokyo: Sushi, ramen, and tempura are vegetarian-adaptable at many restaurants. Indian restaurants are plentiful in Shinjuku (Samrat, New Delhi) for a familiar meal. 7-Eleven and FamilyMart have surprisingly good hot food at ₹180–350.' },
      { type: 'h3', text: 'Day 2 — Akihabara, teamLab & Odaiba' },
      { type: 'p', text: 'Morning: Akihabara Electric Town — Tokyo\'s electronics and anime district. Multi-floor electronics stores, anime figurine shops, maid cafes (curious and uniquely Japanese). Perfect for tech shopping: cameras, gaming gear, headphones at Japanese prices.' },
      { type: 'p', text: 'Afternoon: teamLab Planets (Toyosu, tickets ₹2,800, book weeks ahead) — immersive digital art installation where you walk through rooms of floating flowers and mirror pools. One of the most visually spectacular art experiences in the world. Then Odaiba waterfront — futuristic artificial island with giant Gundam statue, shopping, and Tokyo Bay views.' },
      { type: 'p', text: 'Evening: Shibuya Crossing again at night (even more electric). Rooftop dinner at Gonpachi Nishi-Azabu (the "Kill Bill restaurant") or izakaya hopping in Shimokitazawa.' },
      { type: 'h3', text: 'Day 3 — Nikko or Kamakura Day Trip' },
      { type: 'p', text: 'Nikko (2 hrs by JR): UNESCO World Heritage complex of Tosho-gu Shrine (the most ornate shrine in Japan, covered in gold leaf and intricate carvings). Kegon Falls and Lake Chuzenji nearby. Full day.' },
      { type: 'p', text: 'OR Kamakura (50 min by JR): Great Buddha (Kotoku-in, ₹350), Hase-dera Temple with sea views, the narrow Komachi shopping street, and a short hike on the Daibutsu Hiking Course. Combine with nearby Enoshima island.' },
      { type: 'callout', emoji: '🗼', text: 'Tokyo timing tip: Tokyo DisneySea and TeamLab Planets require advance booking (weeks ahead). Most temples are free and open from dawn. Buy a Suica card (rechargeable transit card) at the airport — works everywhere.' },
      { type: 'link-cta', text: 'Full Tokyo guide: all major attractions, areas to stay, and day-trip options.', href: '/cities/tokyo' },
      { type: 'divider' },
      { type: 'h2', text: 'Days 4–5: Kyoto — Temples, Geisha Districts & Bamboo Groves' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=800&q=80', alt: 'Kyoto Fushimi Inari torii gates', caption: 'Kyoto — 1,600 Buddhist temples, the Fushimi Inari gates, and geisha in Gion at dusk' },
      { type: 'h3', text: 'Day 4 — Arrival in Kyoto + Fushimi Inari & Gion' },
      { type: 'p', text: 'Morning: Shinkansen Tokyo → Kyoto (2 hrs 15 min, covered by JR Pass). Arrive Kyoto Station — check into hotel. Head immediately to Fushimi Inari Shrine (free, open 24hrs). The 10,000 vermilion torii gates winding up a forested mountain are Japan\'s single most iconic image. Go early (before 9am) to beat crowds. Hike to the summit (2 hrs return) for the best views over Kyoto.' },
      { type: 'p', text: 'Afternoon: Kinkaku-ji (Golden Pavilion, ₹420) — Zen Buddhist temple covered in gold leaf, reflected perfectly in the surrounding pond. Queue 20 minutes at peak times. Then Nijo Castle (₹640) — a 17th-century shogun\'s palace with "nightingale floors" that squeak underfoot to detect intruders.' },
      { type: 'p', text: 'Evening: Gion district after dark — Kyoto\'s geisha quarter. Walk Hanamikoji Street (the most photographed street in Japan), Pontocho narrow alley for dinner (upscale kaiseki or casual yakitori). Glimpsing a geiko or maiko walking to an appointment at dusk is one of Japan\'s great chance encounters.' },
      { type: 'h3', text: 'Day 5 — Arashiyama, Nara & Philosopher\'s Path' },
      { type: 'p', text: 'Morning: Arashiyama district (JR Sagano line, 20 min). Bamboo Grove at 7am for no crowds — towering bamboo corridors in absolute silence. Then Tenryu-ji Temple garden (₹550), Monkey Park Iwatayama for Japanese macaques (₹500), Togetsukyo Bridge over the Oi River.' },
      { type: 'p', text: 'Afternoon: Nara day trip (35 min by JR from Kyoto, free with JR Pass) — Nara Park\'s 1,200 free-roaming deer that bow for crackers (₹180/pack), Todai-ji Temple housing Japan\'s largest bronze Buddha statue (₹650). Return Kyoto by 5pm.' },
      { type: 'p', text: 'Evening: Walk the Philosopher\'s Path (2km stone walkway along a canal lined with cherry trees) through Nanzen-ji Temple complex. End at a local izakaya for your last Kyoto dinner.' },
      { type: 'callout', emoji: '🌸', text: 'Cherry blossom (sakura) season is late March–early April in Kyoto. Book accommodation 3–6 months ahead for this window — hotels sell out entirely and prices double. Maruyama Park and Philosopher\'s Path are the best sakura spots.' },
      { type: 'link-cta', text: 'Full Kyoto guide: shrine routes, best neighbourhoods, and how to plan a day in Gion.', href: '/cities/kyoto' },
      { type: 'divider' },
      { type: 'h2', text: 'Day 6: Osaka — Street Food, Castle & Departure' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?auto=format&fit=crop&w=800&q=80', alt: 'Osaka Dotonbori street food district at night', caption: 'Osaka — Dotonbori neon, takoyaki, and the unofficial capital of Japanese street food' },
      { type: 'h3', text: 'Day 6 — Osaka: Dotonbori & Departure' },
      { type: 'p', text: 'Morning: Shinkansen Kyoto → Osaka (15 min, JR Pass). Head to Osaka Castle Park (free grounds, ₹600 for castle interior) — a 16th-century castle with excellent samurai history displays and city views from the top floor.' },
      { type: 'p', text: 'Afternoon: Dotonbori — Osaka\'s riotous food and entertainment district. Eat everything: takoyaki (octopus balls, ₹250), okonomiyaki (savoury pancake, ₹600), kushikatsu (deep-fried skewers, ₹700), Ichiran ramen, soft-serve matcha. The giant moving Kani Doraku crab and the Glico Running Man neon sign are Osaka\'s most famous landmarks.' },
      { type: 'p', text: 'Departure: Osaka Kansai Airport (KIX) is 50 min from Osaka city by Haruka Express (₹1,400, JR Pass). Osaka Itami Airport (domestic flights only) is 25 min from city.' },
      { type: 'callout', emoji: '💰', text: 'Osaka food budget: The entire Dotonbori street food crawl — takoyaki, okonomiyaki, sushi, kushikatsu, and ice cream — costs ₹1,500–2,500 total. Osaka has the most affordable high-quality food in Japan.' },
      { type: 'link-cta', text: 'Full Osaka guide: Dotonbori eating guide, Namba area, and day trips to Universal Studios.', href: '/cities/osaka' },
      { type: 'divider' },
      { type: 'h2', text: 'Japan 6-Day Budget (Per Person from India)' },
      { type: 'table', headers: ['Expense', 'Budget ₹', 'Mid-range ₹', 'Notes'], rows: [
      ...
      { type: 'link-cta', text: 'Japan country page: full visa guide, JR Pass explained, and all city guides.', href: '/countries/japan' },
    ],
    faqs: [
      { question: 'Is 6 days enough for Japan?', answer: '6 days covers the Tokyo–Kyoto–Osaka golden triangle well. You won\'t have time for Hiroshima, Mt Fuji, or Hokkaido. For first-time visitors this route is perfect — add a 2nd trip for the rest.' },
      { question: 'How much does 6 days in Japan cost from India?', answer: 'Budget ₹85,000–1,25,000 per person (including flights). Mid-range ₹1,20,000–1,93,000. Japan is more expensive than Southeast Asia but comparable to Europe, and the quality and experience far exceed the price.' },
      { question: 'Do Indians need a visa for Japan?', answer: 'Yes. Indian passport holders need a Japan Sticker Visa from the Japanese Consulate. Apply with confirmed hotel bookings, return flight, bank statement. Processing 5–7 working days. Fee ₹550.' },
      { question: 'What cities does a 6-day Japan itinerary cover?', answer: 'The classic 6-day Japan route covers Tokyo (days 1–3) for temples, neon districts and world-class food, Kyoto (days 4–5) for temples, geisha districts and bamboo groves, and Osaka (day 6) for street food and the castle before departure — all connected by bullet train.' },
    ],
  },

  {
    ...
    content: [
      ...
      { type: 'callout', emoji: '🛂', text: 'Visa: Japan Sticker Visa from the Japanese Consulate in India (Chennai, Mumbai, Delhi, Bengaluru, Kolkata). Processing 5–7 days. Fee ₹550. Required documents: confirmed hotel bookings, return flight, bank statement (min ₹1.5 lakh).' },
      { type: 'callout', emoji: '🚆', text: 'JR Pass: Buy 7-day JR Pass before leaving India (≈₹26,000). Covers all Shinkansen and JR trains on this route — Tokyo, Hiroshima, Kyoto, Osaka. Buy online at japan-rail-pass.com and activate it on arrival.' },
      { type: 'h2', text: 'Days 1–3: Tokyo — Temples, Tech & City Scale' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=800&q=80', alt: 'Tokyo skyline at night aerial view', caption: 'Tokyo — 37 million people in the world\'s largest metropolis, yet every train arrives within 15 seconds of its timetable' },
      { type: 'p', text: 'Day 1 — Asakusa (Senso-ji Temple, Nakamise shopping), Shibuya Crossing + Sky, Harajuku (Meiji Shrine, Takeshita Street), Shinjuku for dinner and Tokyo\'s famous ramen.' },
      { type: 'p', text: 'Day 2 — teamLab Planets (book weeks ahead, ₹2,800), Akihabara electronics and anime district, Odaiba waterfront, evening Shibuya neon circuit.' },
      { type: 'p', text: 'Day 3 — Hakone day trip (JR + Romancecar, 90 min): Mt Fuji views, Hakone Open Air Museum (₹2,000), Lake Ashi ropeway, Owakudani volcanic valley. This is the best Mt Fuji day trip from Tokyo, weather permitting (June–October mornings are clearest).' },
      { type: 'callout', emoji: '🗻', text: 'Mt Fuji tip: Fuji is frequently cloud-covered. Book a Hakone day for your best-weather day in Tokyo — check the forecast the night before. Sunrise from the 5th Station (direct JR bus from Tokyo) is the most dramatic view, but requires an early start.' },
      { type: 'link-cta', text: 'Full Tokyo guide: top attractions, areas to explore, and day-trip options.', href: '/cities/tokyo' },
      { type: 'divider' },
      { type: 'h2', text: 'Day 4: Hiroshima & Miyajima Island' },
      { type: 'h3', text: 'Day 4 — Hiroshima: The Peace Memorial & Miyajima' },
      { type: 'p', text: 'Morning: Shinkansen Tokyo → Hiroshima (4 hrs, JR Pass). Go directly to the Peace Memorial Park. The Atomic Bomb Dome (the only structure left standing after the 6 August 1945 blast, now a UNESCO monument) and the Peace Memorial Museum (₹200) are among the most important historical sites in the world. Allow 2 hours — it\'s humbling, devastating, and ultimately hopeful.' },
      { type: 'p', text: 'Afternoon: Ferry from Hiroshima pier to Miyajima Island (15 min, JR Pass covers the ferry). Itsukushima Shrine and its famous floating torii gate — one of Japan\'s Three Views, standing in the sea at high tide. Tame deer roam freely on the island. Hike up Mt Misen (500m, 90 min) for panoramic views of the Inland Sea.' },
      { type: 'p', text: 'Dinner: Hiroshima-style okonomiyaki (layered savoury pancake, fundamentally different from Osaka style) at Okonomimura Building — 3 floors of okonomiyaki restaurants, each with its own recipe passed down for generations. Take the evening Shinkansen to Kyoto (90 min).' },
      { type: 'callout', emoji: '✌️', text: 'Hiroshima is not a place of sadness — it\'s a place of remarkable resilience. The city today is modern, lively, and forward-looking. The Peace Memorial Museum ends with letters from survivors calling for a nuclear-free world.' },
      { type: 'divider' },
      { type: 'h2', text: 'Days 5–6: Kyoto — 1,600 Temples, Bamboo & Geisha' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=800&q=80', alt: 'Kyoto Arashiyama bamboo grove', caption: 'Kyoto — 1,600 Buddhist temples, the Arashiyama bamboo grove, and Gion\'s geisha quarter' },
      { type: 'h3', text: 'Day 5 — Fushimi Inari, Kinkaku-ji & Gion' },
      { type: 'p', text: 'Morning (very early): Fushimi Inari Shrine at 6am for no crowds — 10,000 vermilion torii gates winding up a forested mountain. This is Japan\'s most photographed sight and completely free, open 24 hours. Hike to the summit (2 hrs return) for best views.' },
      { type: 'p', text: 'Afternoon: Kinkaku-ji Golden Pavilion (₹420) — Zen temple covered in gold leaf, reflected in a mirror pond. Nijo Castle (₹640) — 17th-century shogun\'s palace with the squeaking "nightingale floors" built to detect assassins.' },
      { type: 'p', text: 'Evening: Gion at dusk — walk Hanamikoji Street (the most photographed street in Japan), Pontocho alley for kaiseki dinner. Possibility of glimpsing a real maiko (apprentice geisha) walking to an appointment.' },
      { type: 'h3', text: 'Day 6 — Arashiyama + Philosopher\'s Path' },
      { type: 'p', text: 'Morning: Arashiyama (JR Sagano line, 20 min) — Bamboo Grove at 7am, Tenryu-ji Temple zen garden (₹550), Jojakko-ji Temple mossy hillside. Monkey Park for Japanese macaques with Kyoto panorama (₹500).' },
      { type: 'p', text: 'Afternoon: Nishiki Market ("Kyoto\'s Kitchen") — a 400-year-old covered market 5 lanes wide and 400m long, packed with pickled vegetables, grilled mochi, fresh tofu, and Kyoto-style street food at every turn.' },
      { type: 'p', text: 'Evening: Philosopher\'s Path (2km canal-side walk lined with cherry trees) through to Nanzen-ji Temple aqueduct. Dinner at a local tofu restaurant — Kyoto is Japan\'s tofu capital and it\'s extraordinary.' },
      { type: 'link-cta', text: 'Full Kyoto guide: temple walking routes, Gion district, and sakura season planning.', href: '/cities/kyoto' },
      { type: 'divider' },
      { type: 'h2', text: 'Day 7: Osaka — Street Food Feast & Departure' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?auto=format&fit=crop&w=800&q=80', alt: 'Osaka Dotonbori at night', caption: 'Osaka Dotonbori — neon signs, takoyaki, okonomiyaki, and unlimited izakayas' },
      { type: 'h3', text: 'Day 7 — Osaka: Dotonbori & Fly Home' },
      { type: 'p', text: 'Morning: Shinkansen Kyoto → Osaka (15 min). Osaka Castle Park (free grounds, castle interior ₹600). Kuromon Ichiba Market ("Osaka\'s Kitchen") — fresh oysters, wagyu beef skewers, crab, and fresh seafood at market prices.' },
      { type: 'p', text: 'Afternoon: Dotonbori — eat everything. Takoyaki (₹250), Osaka-style okonomiyaki (₹600), kushikatsu deep-fried skewers (₹700), Glico Running Man neon selfie. Namba shopping district and Den Den Town for electronics.' },
      { type: 'p', text: 'Departure: Kansai Airport (KIX) — Haruka Express from Osaka Station (50 min, JR Pass). Allow 3 hours before international departure.' },
      { type: 'link-cta', text: 'Full Osaka guide: food district map, Namba, and Universal Studios Japan.', href: '/cities/osaka' },
      { type: 'divider' },
      { type: 'h2', text: 'Japan 7-Day Budget (Per Person from India)' },
      { type: 'table', headers: ['Expense', 'Budget ₹', 'Mid-range ₹', 'Notes'], rows: [
      ...
      { type: 'link-cta', text: 'Japan country page: visa guide, JR Pass details, all city guides and best time to visit.', href: '/countries/japan' },
    ],
    faqs: [
      { question: 'What is the best 7-day Japan itinerary?', answer: 'Tokyo (3 nights) → Hiroshima + Miyajima (1 day stop) → Kyoto (2 nights) → Osaka (1 day, fly out). This covers Japan\'s urban scale (Tokyo), historical depth (Hiroshima), cultural peak (Kyoto), and food culture (Osaka) in one seamless bullet-train loop.' },
      { question: 'Is Japan expensive for Indian travellers?', answer: 'More expensive than Southeast Asia, comparable to Europe. Budget ₹90,000–1,34,000 per person for 7 days including flights. The 7-day JR Pass (₹26,000) is the single best investment — it covers all Shinkansen travel between cities.' },
      { question: 'Do Indians need a visa for Japan?', answer: 'Yes. Indian passport holders need a Japan Sticker Visa from the Japanese Consulate, applied for with confirmed hotel bookings, return flights and a bank statement. Processing takes 5–7 working days and the fee is ₹550.' },
      { question: 'What cities does a 7-day Japan itinerary cover?', answer: 'A 7-day Japan itinerary covers Tokyo (days 1–3), a stop at Hiroshima and Miyajima Island (day 4), Kyoto (days 5–6), and Osaka (day 7) — one seamless bullet-train loop through Japan\'s biggest city, its historical heart, its cultural capital and its food capital.' },
    ],
  },
  ...
  // ── GEORGIA ITINERARIES ─────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: 'callout', emoji: '🛂', text: 'Visa-free entry: Indian passport holders can enter Georgia without a visa for up to 365 days. Just your passport and a return ticket. No application, no fees. One of the world\'s most generous visa policies for Indians.' },
      { type: 'h2', text: 'Days 1–2: Tbilisi — Sulphur Baths, Narikala & Old Town' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1589656966895-2f33e7653819?auto=format&fit=crop&w=800&q=80', alt: 'Tbilisi Old Town colourful buildings on cliff', caption: 'Tbilisi Old Town — pastel balconied houses stacked on a cliff above the Mtkvari River' },
      { type: 'h3', text: 'Day 1 — Tbilisi Arrival & Old Town' },
      { type: 'p', text: 'Morning: Arrive Tbilisi International Airport (metro to city centre ₹18, taxi ₹450). Walk the Old Town (Kala) — cobblestone streets, wooden-balconied houses in brick orange and dusty rose, Orthodox churches crammed between art deco facades. Start at Metekhi Church (5th century, perched on a cliff above the river) for the definitive Tbilisi panorama.' },
      { type: 'p', text: 'Afternoon: Narikala Fortress (free) — 4th-century citadel above the city, reached by cable car from Rike Park (₹55 return). Walk the fortress walls for 360° views over Tbilisi and the Mtkvari River. Then Abanotubani — the sulphur bath district. The domed bathhouses (bania) pipe natural hot sulphur spring water at 37–40°C. A private room at Orbeliani Baths costs ₹900–1,500/hour.' },
      { type: 'p', text: 'Evening: Rustaveli Avenue for evening strolling — Georgia\'s main boulevard of museums, theatres, and cafes. Dinner at a traditional Georgian restaurant for khinkali (soup dumplings, ₹40 each), khachapuri (cheese bread in three regional styles, ₹200–350), and a carafe of house red wine (₹220).' },
      { type: 'callout', emoji: '🍷', text: 'Georgian wine tip: Georgia invented wine 8,000 years ago. Order an amber/orange wine (qvevri wine, made in clay pots) — nothing like it exists elsewhere. Rkatsiteli (white) and Saperavi (red) are the signature grapes. A decent bottle at a restaurant costs ₹800–1,400.' },
      { type: 'h3', text: 'Day 2 — Tbilisi: Markets, Museums & Fabrika' },
      { type: 'p', text: 'Morning: Dry Bridge Flea Market (open daily, peak on weekends) — Soviet memorabilia, antique jewellery, carpets, vintage cameras, Georgian folk art. A genuine antique souvenir market with low prices if you haggle. National Museum of Georgia (₹330) — stunning collection from Colchian gold to medieval art.' },
      { type: 'p', text: 'Afternoon: Tbilisi Botanical Garden (₹90) carved into a gorge below Narikala — a Tbilisi secret most tourists miss. Then the Holy Trinity Cathedral (Tsminda Sameba) — Georgia\'s largest cathedral (2004), magnificent from a distance and cavernous inside, with a hilltop position overlooking the whole city.' },
      { type: 'p', text: 'Evening: Fabrika — a repurposed Soviet sewing factory turned into Tbilisi\'s coolest food and arts complex. Container restaurants, craft beer, terrace concerts, vintage shops. This is where young Tbilisi socialises. Try Shavi Lomi or Vino Underground for natural Georgian wine.' },
      { type: 'link-cta', text: 'Full Tbilisi guide: Old Town walking route, sulphur baths, food and wine scene.', href: '/cities/tbilisi' },
      { type: 'divider' },
      { type: 'h2', text: 'Day 3: Kazbegi — Gergeti Trinity Church & Caucasus Mountains' },
      { type: 'h3', text: 'Day 3 — Kazbegi Mountain Day Trip' },
      { type: 'p', text: 'Morning: Depart Tbilisi 8am by marshrutka (minibus from Didube bus station, ₹150) or private car (₹1,800–2,200 return shared, book through hotel). 3-hour drive north on the Georgian Military Highway — one of the most dramatic mountain roads in the world, following the Aragvi River gorge past the castle ruins of Ananuri and into the High Caucasus.' },
      { type: 'p', text: 'Afternoon: Arrive Kazbegi (Stepantsminda). The village sits at 1,740m; Gergeti Trinity Church at 2,170m on a promontory above the village; Mt Kazbegi (5,047m) towering behind it, capped with eternal snow. Hike to the 14th-century Gergeti Trinity Church (2 hrs return, steep but manageable). The combination of the ancient stone church, the Caucasus mountains, and the vertiginous position is among the most spectacular sights in all of Europe.' },
      { type: 'p', text: 'Evening: Dinner in Kazbegi village at a local guesthouse — Georgian mountain bread (shotis puri), trout from the Terek River, locally produced Kazbegi beer. Return to Tbilisi by 9pm.' },
      { type: 'callout', emoji: '🏔️', text: 'Weather tip: The Kazbegi road can be misty or cloud-covered — best chance of clear Caucasus views is early morning (June–September). Call ahead to a Kazbegi guesthouse for same-day mountain weather updates.' },
      { type: 'divider' },
      { type: 'h2', text: 'Day 4: Mtskheta — Georgia\'s Ancient Capital' },
      { type: 'h3', text: 'Day 4 — Mtskheta UNESCO World Heritage City' },
      { type: 'p', text: 'Morning: Drive 20km northwest to Mtskheta (30 min, taxi ₹360 return) — Georgia\'s original capital and a UNESCO World Heritage Site. Svetitskhoveli Cathedral, the main patriarchal cathedral of the Georgian Orthodox Church (11th century), is one of the most beautiful and historically significant buildings in the Caucasus. According to legend, Christ\'s robe is buried here.' },
      { type: 'p', text: 'Afternoon: Hike up to Jvari Monastery (5th century, perched on a clifftop above the confluence of the Aragvi and Mtkvari Rivers) — the view looking down at the two rivers and Mtskheta below is the classic Georgia postcard. The monastery appears in Mikhail Lermontov\'s famous poem "Mtsyri".' },
      { type: 'p', text: 'Evening: Return to Tbilisi. Wander Shardeni Street (Tbilisi\'s most atmospheric narrow lane, lined with small galleries, wine bars, and pavement cafe tables). Dinner: Poliphonia restaurant for Georgian traditional food at its finest.' },
      { type: 'divider' },
      { type: 'h2', text: 'Days 5–6: Kakheti Wine Region & Sighnaghi' },
      { type: 'h3', text: 'Day 5 — Kakheti Wine Country Day Trip' },
      { type: 'p', text: 'Morning: Day trip to Kakheti (2 hrs east, private car ₹2,800–3,500 for the day or shared tour ₹1,200). Stop at Bodbe Monastery (9th century, burial site of St Nino who brought Christianity to Georgia in 337 AD). Continue to Alazani Valley wine producers.' },
      { type: 'p', text: 'Afternoon: Winery visits in Kvareli or Telavi — Twins Wine House (allows you to make your own qvevri wine, ₹1,500), Schuchmann Wines, or Pheasant\'s Tears in Sighnaghi. Unlimited tasting of Georgian natural wines and chacha (grape brandy). Georgian feast (supra) if arranged ahead.' },
      { type: 'p', text: 'Evening: Stay in Sighnaghi — a hilltop walled town called "the City of Love" (it has Georgia\'s only 24-hour marriage registration office). Beautiful terracotta-roofed town with stunning Alazani Valley and Caucasus views. Dinner at a family guesthouse with home-made wine included.' },
      { type: 'callout', emoji: '🍇', text: 'Wine experience: Book a winery visit at Twins Wine House or Shumi Winery in Kvareli for a guided cellar tour and tasting of 6–8 wines for ₹1,200–2,000. Georgia\'s natural qvevri wines are completely different from anything you\'ve tried elsewhere.' },
      { type: 'h3', text: 'Day 6 — Tbilisi Final Day & Departure' },
      { type: 'p', text: 'Morning: Return to Tbilisi. Visit the Georgian National Museum\'s Treasury (gold and silver collection from Colchian burial sites, ₹330). Abanotubani sulphur bath if you missed it on Day 1.' },
      { type: 'p', text: 'Afternoon: Last khinkali and khachapuri lunch. Browse Erekle II Street craft shops for Georgian enamel cloisonné, silver Caucasian belt daggers (decorative), wine in terracotta pots, and churchkhela (walnut grape candy). Tbilisi International Airport is 20 min from city centre by taxi (₹450) or metro.' },
      { type: 'link-cta', text: 'Full Tbilisi guide: city highlights, wine bars, sulphur baths and day-trip options.', href: '/cities/tbilisi' },
      { type: 'divider' },
      { type: 'h2', text: 'Georgia 6-Day Budget (Per Person from India)' },
      { type: 'table', headers: ['Expense', 'Budget ₹', 'Mid-range ₹', 'Notes'], rows: [
        ['Return flights from India', '18,000–32,000', '28,000–50,000', 'IndiGo via Almaty, FlyDubai'],
        ['Visa', 'FREE', 'FREE', 'Visa-free for Indians, 365 days'],
        ['6 nights accommodation', '5,400–9,000', '10,800–21,600', 'Guesthouse vs boutique hotel'],
        ['Food (6 days)', '3,600–6,000', '7,200–12,000', 'Local vs tourist restaurants'],
        ['Kazbegi + Mtskheta transport', '2,200–3,800', '3,500–5,500', 'Shared car vs private'],
        ['Kakheti wine tour', '1,200–3,500', '2,500–6,000', 'Group tour vs private winery'],
        ['Activities', '1,000–2,500', '2,000–4,500', 'Museums, cable car, baths'],
        ['TOTAL', '≈₹31,000–57,000', '≈₹54,000–1,00,000', 'Per person return'],
      ]},
      { type: 'h2', text: 'Essential Tips for Indians' },
      { type: 'ul', items: [
      ...
      { type: 'link-cta', text: 'Georgia country page: visa info, all destinations, best time to visit.', href: '/countries/georgia' },
    ],
    faqs: [
      { question: 'Do Indians need a visa for Georgia?', answer: 'No. Indian passport holders can enter Georgia visa-free for up to 365 days. Just your passport and a return ticket. No application, no fees — one of the most generous visa policies in the world for Indian travellers.' },
      { question: 'Is Georgia safe for Indian tourists?', answer: 'Yes. Georgia is one of the safest countries in Europe by crime statistics. Petty crime is very low, locals are welcoming to Indian visitors, and the country has a strong tradition of hospitality (the Georgian word "mgzavri" for guest has a deeply sacred cultural meaning).' },
      { question: 'How much does 6 days in Georgia cost from India?', answer: 'Budget ₹31,000–57,000 per person (including flights). Georgia is significantly cheaper than Western Europe and comparable to Southeast Asia. Wine, food, accommodation, and transport are all excellent value.' },
      { question: 'What is the best time to visit Georgia?', answer: 'May–June and September–October are the best times to visit Georgia — warm days, mild evenings and accessible mountain roads. Kazbegi is snowbound from November to March, while July–August is hot in Tbilisi (around 35°C) but perfect in the mountains.' },
    ],
  },

  {
    ...
    content: [
      ...
      { type: 'callout', emoji: '🛂', text: 'No visa needed. Indian passport holders enter Georgia visa-free for up to 365 days. Just your passport. No fees, no application.' },
      { type: 'h2', text: 'Days 1–3: Tbilisi — Full City Immersion' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1589656966895-2f33e7653819?auto=format&fit=crop&w=800&q=80', alt: 'Tbilisi Old Town colourful buildings', caption: 'Tbilisi — the Caucasus\'s most charming capital, where East meets Orthodox Europe in pastel balcony houses' },
      { type: 'h3', text: 'Day 1 — Old Town, Narikala & Sulphur Baths' },
      { type: 'p', text: 'Explore Old Town (Kala), Narikala Fortress (cable car from Rike Park, ₹55 return), Metekhi Church for panoramic city views. Evening at Abanotubani sulphur baths in a private room (₹900–1,500/hr) — natural hot sulphur spring water at 37°C. Dinner: Khinkali (soup dumplings), khachapuri, chacha brandy.' },
      { type: 'h3', text: 'Day 2 — Museums, Markets & Holy Trinity' },
      { type: 'p', text: 'Dry Bridge Flea Market in the morning (Soviet antiques, Georgian silverware, carpets). National Museum of Georgia (₹330). Holy Trinity Cathedral at sunset — Georgia\'s largest cathedral with the city spread below. Evening at Fabrika food court and creative complex.' },
      { type: 'h3', text: 'Day 3 — Mtskheta & Jvari UNESCO Day Trip' },
      { type: 'p', text: 'Mtskheta (20km, 30 min taxi ₹360 return) — Svetitskhoveli Cathedral (11th century, Georgia\'s most sacred church) and Jvari Monastery (5th century, cliff-top position above the river confluence). Return Tbilisi. Botanical Garden in the afternoon gorge below Narikala. Tbilisi wine bar evening at Vino Underground or Shardeni Street.' },
      { type: 'link-cta', text: 'Full Tbilisi guide: Old Town, sulphur baths, wine bars and day trips.', href: '/cities/tbilisi' },
      { type: 'divider' },
      { type: 'h2', text: 'Days 4–5: Kazbegi — Overnight in the High Caucasus' },
      { type: 'h3', text: 'Day 4 — Drive to Kazbegi, Gergeti Trinity Church' },
      { type: 'p', text: 'Morning: Private car from Tbilisi (₹2,200–2,800 one way, book through hotel). 3-hour drive on the Georgian Military Highway — the route passes Ananuri Castle (16th-century fortress above a reservoir, worth a 30-min stop), the tunnel at Gudauri ski resort, and into the High Caucasus at Kazbegi (Stepantsminda, 1,740m).' },
      { type: 'p', text: 'Afternoon: Hike to Gergeti Trinity Church (2,170m) — 2-hour round-trip hike from the village, steep but paved for the final section. Standing at the 14th-century church with Mt Kazbegi (5,047m) behind and the Terek River gorge below is the single finest viewpoint in the Caucasus. Alternatively, hire a 4WD to drive up (₹900).' },
      { type: 'p', text: 'Evening: Dinner and overnight at a Kazbegi guesthouse (₹1,800–3,200 per night, typically includes breakfast and dinner). Mountain trout, fresh bread from the tonir clay oven, locally produced honey. At this altitude the night sky is extraordinary.' },
      { type: 'callout', emoji: '🏔️', text: 'Stay recommendation: Rooms Hotel Kazbegi (₹6,000–9,000/night, infinity pool facing Mt Kazbegi) for a luxury experience. For budget: Guesthouse Nino (₹1,800–2,200 including meals). Both book up — reserve 1–2 months ahead.' },
      { type: 'h3', text: 'Day 5 — Kazbegi Hikes & Return to Tbilisi' },
      { type: 'p', text: 'Morning: Wake at 6am for dawn over Kazbegi — the mountain turns pink with first light. Shorter hike to Arsha village or along the Terek River valley. Visit the local market for churchkhela (walnut grape candy, ₹60–150) and local honey.' },
      { type: 'p', text: 'Afternoon: Drive back to Tbilisi (3 hrs), stopping at Gudauri viewpoint for one last mountain panorama. Afternoon free for Tbilisi souvenirs and shopping — Georgian enamel cloisonné jewellery, natural wine from a bottle shop, silk and velvet in Marjanishvili area.' },
      { type: 'divider' },
      { type: 'h2', text: 'Day 6: Kakheti — Wine & Sighnaghi' },
      { type: 'h3', text: 'Day 6 — Kakheti Wine Valley Day Trip' },
      { type: 'p', text: 'Morning: Drive 2 hrs east to Alazani Valley — Georgia\'s premier wine region, home to the original 8,000-year-old qvevri wine tradition. Visit Bodbe Monastery (9th century, burial of St Nino), the town of Telavi (wine capital of Kakheti), and a family-run winery for a cellar tour with 6-wine tasting (₹1,200–2,000).' },
      { type: 'p', text: 'Afternoon: Sighnaghi — "the City of Love", a walled hilltop town with terracotta-roofed houses, views over the entire Alazani Valley to the Caucasus mountains on the horizon. Wine bar hopping along Sighnaghi\'s small but exceptional wine bar street. Pheasant\'s Tears natural wine is not to be missed.' },
      { type: 'p', text: 'Evening: Return to Tbilisi for final night. Optional: farewell khinkali dinner at Zakhar Zakharich restaurant — the best traditional restaurant in Tbilisi.' },
      { type: 'divider' },
      { type: 'h2', text: 'Day 7: Kutaisi Cave System & Departure (Optional Extension)' },
      { type: 'h3', text: 'Day 7 — Kutaisi or Departure' },
      { type: 'p', text: 'Option A (if departing from Kutaisi Airport — often cheaper): Drive 3 hrs west to Kutaisi. Prometheus Cave (₹660, guided 1.5hr boat tour through illuminated stalactite chambers — one of Europe\'s most spectacular cave systems). Gelati Monastery (12th century, UNESCO, fresco-covered walls). Fly home from Kutaisi International Airport (Wizz Air flies Kutaisi–various European hubs).' },
      { type: 'p', text: 'Option B (departing Tbilisi): Final morning at leisure. Tbilisi airport is 20 min from city (taxi ₹450). Browse Rustaveli Avenue one last time, buy wine from Goodwill supermarket (far cheaper than airport shops), and take an afternoon or evening flight home.' },
      { type: 'callout', emoji: '💡', text: 'Budget tip: Kutaisi Airport has cheaper flights to India (via Wizz Air to Budapest + IndiGo connecting, or direct charters). Check both TBS and KUT airports when booking to save ₹5,000–12,000 on flights.' },
      { type: 'link-cta', text: 'Georgia country page: visa info, all city guides, Kazbegi and Kakheti planning.', href: '/countries/georgia' },
      { type: 'divider' },
      { type: 'h2', text: 'Georgia 7-Day Budget (Per Person from India)' },
      { type: 'table', headers: ['Expense', 'Budget ₹', 'Mid-range ₹', 'Notes'], rows: [
      ...
      { type: 'link-cta', text: 'Georgia country page: full planning guide, visa, best time, all destinations.', href: '/countries/georgia' },
    ],
    faqs: [
      { question: 'Is Georgia worth visiting for Indian tourists?', answer: 'Absolutely. Georgia offers European-level scenery and culture at Southeast Asian prices, with zero visa hassle for Indians (365-day visa-free). The combination of Tbilisi\'s charming Old Town, Kazbegi\'s Caucasus mountain scenery, and ancient wine culture makes it one of the best-value travel destinations in the world right now.' },
      { question: 'What is the best time to visit Georgia?', answer: 'May–June and September–October are ideal — warm days, mild evenings, and the mountains accessible. July–August is hot in Tbilisi (35°C) but beautiful in Kazbegi. Avoid December–March for Kazbegi (snowbound roads), but Tbilisi in winter is cosy and atmospheric.' },
      { question: 'Do Indians need a visa for Georgia?', answer: 'No. Indian passport holders can enter Georgia visa-free for up to 365 days — just a passport and a return ticket, with no application and no fees.' },
      { question: 'How much does 7 days in Georgia cost from India?', answer: 'A 7-day Georgia trip costs roughly ₹34,000–60,000 per person on a budget and ₹58,000–1,06,000 mid-range, including return flights from India. Georgia is significantly cheaper than Western Europe and comparable to Southeast Asia in daily costs.' },
    ],
  },
...
/** Indexable posts covering a city — powers the "Guides & Itineraries" module
 *  on city pages. Matches the explicit `cities` field first, then falls back to
 *  citySlug / tag matching so unpopulated future posts still surface. */
export function getPostsForCity(citySlug: string, cityName: string, count = 6): BlogPost[] {
  const name = cityName.toLowerCase();
  return allPosts
    .filter(p => isIndexablePost(p) && (
      p.cities?.includes(citySlug) ||
      p.citySlug === citySlug ||
      p.tags.some(t => t.toLowerCase() === name || t.toLowerCase() === citySlug)
    ))
    .slice(0, count);
}
